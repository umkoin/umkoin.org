...
<a href="/en/development#devcommunities">Bitcoin development communities</a>.
...
definition of the term will be displayed in a tooltip.</p>
  ...
  <div class="subhead-links sourcefile" data-sourcefile="_data/devdocs/en/guides/block_chain.md"><a href="https://github.com/umkoin/umkoin.org/edit/master/_data/devdocs/en/guides/block_chain.md">Редагувати</a>
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/guides/block_chain.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/guides/block_chain.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development#devcommunities">Обговорити</a>

| <a href="/uk/development#devcommunities">Перекласти</a>

</div>

  <p>The <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> provides Bitcoin’s public ledger, an ordered and timestamped record
...
and modification of previous transaction records.</p>
  ...
  <p>Each <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">full node</a> in the Bitcoin <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> independently stores a <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>
containing only <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> validated by that <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>. When several <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> all
...
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> follow to maintain <a href="/en/glossary/consensus" title="When several nodes (usually most nodes on the network) all have the same blocks in their locally-validated best block chain." class="auto-link">consensus</a> are called <a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." id="term-consensus-rules" class="term">consensus
rules</a>. This section describes many of
the <a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">consensus rules</a> used by Bitcoin Core.</p>
...
<a href="/en/glossary/merkle-root" title="The root node of a merkle tree, a descendant of all the hashed pairs in the tree.  Block headers must include a valid merkle root descended from all transactions in that block." id="term-merkle-root" class="term">merkle root</a> of a <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Bitcoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a>.</p>
...
modifying the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> that records it and all following <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>.</p>
  ...
  <p>Transactions are also chained together. Bitcoin <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> software gives
the impression that <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> are sent from and to <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallets</a>, but
<a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">bitcoins</a> really move from transaction to transaction. Each
transaction spends the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> previously received in one or more earlier
transactions, so the <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a> of one transaction is the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> of a
previous transaction.</p>

  <p><img src="/img/dev/en-transaction-propagation.svg" alt="Transaction Propagation" /></p>

  <p>A single transaction can create multiple <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>, as would be
the case when sending to multiple <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a>, but each <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> of
...
spend</a>—an attempt to spend the same <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> twice.</p>

  <p><a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">Outputs</a> are tied to <a href="/en/glossary/txid" title="An identifier used to uniquely identify a particular transaction; specifically, the sha256d hash of the transaction." id="term-txid" class="term">transaction identifiers (TXIDs)</a>, which are the hashes
of signed transactions.</p>

  <p>Because each <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> of a particular transaction can only be spent once,
...
transaction’s <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> exceed its <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a>, the transaction will be
rejected—but if the <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a> exceed the value of the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>, any
...
<a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." id="term-miner" class="term">miner</a> who creates the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> containing that
transaction.
For example, in the illustration above, each transaction spends 10,000 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
...
<a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshi</a> <a href="/en/glossary/transaction-fee" title="The amount remaining when the value of all outputs in a transaction are subtracted from all inputs in a transaction; the fee is paid to the miner who includes that transaction in a block." class="auto-link">transaction fee</a>.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>The <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> is collaboratively maintained by anonymous <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> on the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, so
Bitcoin requires that each <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> prove a significant amount of work was invested in
its creation to ensure that untrustworthy <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> who want to modify past <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> have
to work harder than honest <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> who only want to add new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> to the
...
threshold.
Bitcoin assumes a linear probability that the lower it makes the <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target threshold</a>, the more hash attempts (on average) will need to be tried.</p>
...
Every 2,016 <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>, the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> uses timestamps stored in each
<a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block header</a> to calculate the number of seconds elapsed between generation
of the first and last of those last 2,016 <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>. The ideal value is
1,209,600 seconds (two weeks).</p>

  <ul>
    <li>
      <p>If it took fewer than two weeks to generate the 2,016 <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>,
the expected <a href="/en/glossary/difficulty" title="How difficult it is to find a block relative to the difficulty of finding the easiest possible block. The easiest possible block has a proof-of-work difficulty of 1." class="auto-link">difficulty</a> value is increased proportionally (by as much
as 300%) so that the next 2,016 <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> should take exactly two weeks
to generate if hashes are checked at the same rate.</p>
    </li>
    <li>
      <p>If it took more than two weeks to generate the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>, the expected
<a href="/en/glossary/difficulty" title="How difficult it is to find a block relative to the difficulty of finding the easiest possible block. The easiest possible block has a proof-of-work difficulty of 1." class="auto-link">difficulty</a> value is decreased proportionally (by as much as 75%) for
the same reason.</p>
    </li>
  </ul>

  <p>(Note: an off-by-one error in the Bitcoin Core implementation causes the
<a href="/en/glossary/difficulty" title="How difficult it is to find a block relative to the difficulty of finding the easiest possible block. The easiest possible block has a proof-of-work difficulty of 1." class="auto-link">difficulty</a> to be updated every 2,01<em>6</em> <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> using timestamps from only
2,01<em>5</em> <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>, creating a slight skew.)</p>
...
the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Bitcoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a>.</p>
...
by their <a href="/en/glossary/block-height" title="The number of blocks preceding a particular block on a block chain. For example, the genesis block has a height of zero because zero block preceded it." id="term-block-height" class="term">block height</a>—the number of <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> between them and the first Bitcoin
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> (<a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." class="auto-link">block 0</a>, most commonly known as the <a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." id="term-genesis-block" class="term">genesis block</a>). For example,
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> 2016 is where <a href="/en/glossary/difficulty" title="How difficult it is to find a block relative to the difficulty of finding the easiest possible block. The easiest possible block has a proof-of-work difficulty of 1." class="auto-link">difficulty</a> could have first been adjusted.</p>
...
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>, normal <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> always follow the most difficult chain
...
<a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> almost always do include additional transactions in order to
...
identifier</a> (<a href="/en/glossary/txid" title="An identifier used to uniquely identify a particular transaction; specifically, the sha256d hash of the transaction." class="auto-link">txid</a>). From these <a href="/en/glossary/txid" title="An identifier used to uniquely identify a particular transaction; specifically, the sha256d hash of the transaction." class="auto-link">txids</a>, the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Bitcoin, the leaves are almost always transactions from a single block." id="term-merkle-tree" class="term">merkle tree</a> is constructed by pairing each
...
five-transaction <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Bitcoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a> would look like the following text diagram:</p>
...
the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Bitcoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a> allows clients to verify for
...
from a full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a>. The full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> does not need to be trusted: it is
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>To maintain <a href="/en/glossary/consensus" title="When several nodes (usually most nodes on the network) all have the same blocks in their locally-validated best block chain." class="auto-link">consensus</a>, all full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> validate <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> using the same
...
introduce new features or prevent <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> abuse. When the new rules are
implemented, there will likely be a period of time when non-upgraded
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> follow the old rules and upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> follow the new rules,
...
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> but rejected by non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>. For example, a new
transaction feature is used within a <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>: upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> understand
the feature and accept it, but non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> reject it because
...
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> but accepted by non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>. For example, an abusive
transaction feature is used within a <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>: upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> reject it
because it violates the new rules, but non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> accept it
because it follows the old rules.</p>
    </li>
  </ol>

  <p>In the first case, rejection by non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>, <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software
which gets <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> data from those non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> refuses to
build on the same chain as <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software getting data from upgraded
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>. This creates permanently divergent chains—one for non-upgraded
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> and one for upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>—called a <a href="/en/glossary/hard-fork" title="A permanent divergence in the block chain, commonly occurs when non-upgraded nodes can't validate blocks created by upgraded nodes that follow newer consensus rules." id="term-hard-fork" class="term">hard
fork</a>.</p>

  <p><img src="/img/dev/en-hard-fork.svg" alt="Hard Fork" /></p>

  <p>In the second case, rejection by upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>, it’s possible to keep
the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> from permanently diverging if upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> control a
majority of the hash rate. That’s because, in this case, non-upgraded
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> will accept as valid all the same <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> as upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>, so the
upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> can build a stronger chain that the non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>
...
requires a <a href="/en/glossary/hard-fork" title="A permanent divergence in the block chain, commonly occurs when non-upgraded nodes can't validate blocks created by upgraded nodes that follow newer consensus rules." class="auto-link">hard fork</a>.” In this example, an actual <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> <a href="/en/glossary/fork" title="When two or more blocks have the same block height, forking the block chain.  Typically occurs when two or more miners find blocks at nearly the same time.  Can also happen as part of an attack." class="auto-link">fork</a> is
...
first two years, <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">Satoshi</a> Nakamoto performed several <a href="/en/glossary/soft-fork" title="A softfork is a change to the bitcoin protocol  wherein only previously valid blocks/transactions  are made invalid. Since old nodes will recognise  the new blocks as valid, a softfork is backward-compatible." class="auto-link">soft forks</a> by just 
...
they are dependent on having sufficient users (<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>) to enforce the new rules
...
to signal their readiness for enforcing the new <a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">consensus rules</a>. Once the signalling
threshold has been passed, all <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> will begin enforcing the new rules. Such
...
as they are dependent on <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> for activation.</p>
...
of upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>, and an intentional <a href="/en/glossary/hard-fork" title="A permanent divergence in the block chain, commonly occurs when non-upgraded nodes can't validate blocks created by upgraded nodes that follow newer consensus rules." class="auto-link">hard fork</a> when the temporary
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> may use and distribute incorrect information during
...
financial loss. In particular, non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> may relay and accept
transactions that are considered invalid by upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> and so will
...
Non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> may also refuse to relay <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> or transactions which
...
provide incomplete information.</p>
  ...
  <p>Bitcoin Core includes code that detects a <a href="/en/glossary/hard-fork" title="A permanent divergence in the block chain, commonly occurs when non-upgraded nodes can't validate blocks created by upgraded nodes that follow newer consensus rules." class="auto-link">hard fork</a> by looking at <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block
chain</a> <a href="/en/glossary/proof-of-work" title="A hash below a target value which can only be obtained, on average, by performing a certain amount of brute force work---therefore demonstrating proof of work." class="auto-link">proof of work</a>. If a non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> receives <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a>
...
it considers valid, the <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> reports a warning in the <a href="/en/developer-reference#getnetworkinfo" class="auto-link"><code>getnetworkinfo</code> RPC</a>
results and runs the <code>-alertnotify</code> command if set.  This warns the
operator that the non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> can’t switch to what is likely the
<a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a>.</p>
  ...
  <p>Full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> can also check <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> and transaction version numbers. If the
...
higher than the version numbers the <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> uses, it can assume it doesn’t
use the current <a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">consensus rules</a>. Bitcoin Core reports this situation 
...
if it comes from a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> that apparently isn’t using the current 
<a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">consensus rules</a>.</p>
  ...
  <p><a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV clients</a> which connect to full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> can detect a likely <a href="/en/glossary/hard-fork" title="A permanent divergence in the block chain, commonly occurs when non-upgraded nodes can't validate blocks created by upgraded nodes that follow newer consensus rules." class="auto-link">hard fork</a> by
connecting to several full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> and ensuring that they’re all on the
...
divergence, the client can disconnect from <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> with weaker chains.</p>
...
transactions using the current <a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">consensus rules</a>.</p>
  ...
  <div class="subhead-links sourcefile" data-sourcefile="_data/devdocs/en/guides/transactions.md"><a href="https://github.com/umkoin/umkoin.org/edit/master/_data/devdocs/en/guides/transactions.md">Редагувати</a>
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/guides/transactions.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/guides/transactions.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development#devcommunities">Обговорити</a>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Transactions let users spend <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>. Each transaction is constructed
...
not exist. <a href="/en/glossary/coinbase-transaction" title="The first transaction in a block.  Always created by a miner, it includes a single coinbase." class="auto-link">Coinbase transactions</a> can only be created by Bitcoin <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a>
...
transaction has at least one <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a> and one <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>. Each <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." id="term-input" class="term">input</a> spends the
<a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> paid to a previous <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>. Each <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." id="term-output" class="term">output</a> then waits as an Unspent
Transaction <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">Output</a> (<a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a>) until a later <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a> spends it. When your
Bitcoin <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> tells you that you have a 10,000 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshi</a> balance, it really
means that you have 10,000 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> waiting in one or more <a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a>.</p>
...
Bitcoin <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> and <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> which set of rules to use to validate it.  This
...
invalidating previous transactions.</p>
  ...
  <p>An <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> has an implied index number based on its location in the
transaction—the index of the first <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> is zero. The <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> also has an
amount in <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> which it pays to a conditional <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey script</a>. Anyone
...
amount of <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> paid to it.</p>
...
(often called “vout” for <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> vector) to identify a particular <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> to
...
type. <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." id="term-p2pkh" class="term">P2PKH</a> lets Alice spend <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to a typical Bitcoin <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>,
and then lets Bob further spend those <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> using a simple
...
from <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a> data at some later point.</p>
  ...
  <p>Bob provides the <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hash</a> to Alice. <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">Pubkey hashes</a> are almost always
sent encoded as Bitcoin <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." id="term-address" class="term">addresses</a>, which are <a href="/en/glossary/base58check" title="The method used in Bitcoin for converting 160-bit hashes into P2PKH and P2SH addresses.  Also used in other parts of Bitcoin, such as encoding private keys for backup in WIP format.  Not the same as other base58 implementations." class="auto-link">base58</a>-encoded strings
containing an <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> version number, the hash, and an error-detection
checksum to catch typos. The <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> can be transmitted
...
URI</a>.</p>
  ...
  <p>Once Alice has the <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> and decodes it back into a standard hash, she
...
The <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> categorizes it as an Unspent Transaction <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">Output</a> (<a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a>), and Bob’s
...
a <a href="/en/glossary/txid" title="An identifier used to uniquely identify a particular transaction; specifically, the sha256d hash of the transaction." class="auto-link">Transaction Identifier</a> (<a href="/en/glossary/txid" title="An identifier used to uniquely identify a particular transaction; specifically, the sha256d hash of the transaction." class="auto-link">txid</a>), and the specific <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> she used by its
...
hashes to the same value as the <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hash</a> provided by Alice.</p>
    </li>
    <li>
...
broadcast them over the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>.</p>
...
recipient spend this transaction’s <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>, and the amount of <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to
...
broadcasts the transaction to Bitcoin <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> through the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer
network</a>. Each <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> and <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> independently validates the transaction
...
In a <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">P2PKH output</a>, the <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey script</a> is:</p>
...
evaluation of a standard <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">P2PKH pubkey script</a>; below the figure is a description
of the process.</p>
...
This creates a hash of Bob’s <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a>.</p>
    ...
    <li>
      <p>Alice’s <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey script</a> then pushes the <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hash</a> that Bob gave her for the
first transaction.  At this point, there should be two copies of Bob’s
<a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hash</a> at the top of the stack.</p>
    </li>
    <li>
...
<a href="/en/developer-reference#term-op-equalverify" title="Operation which terminates the script in failure unless the two entries below it on the stack are equivalent" class="auto-link"><code>OP_EQUALVERIFY</code></a> is equivalent to executing <a href="/en/developer-reference#term-op-equal" title="Operation which returns true if the two entries below it on the stack are equivalent" class="auto-link"><code>OP_EQUAL</code></a> followed by <a href="/en/developer-reference#term-op-verify" title="Operation which terminates the script if the entry below it on the stack is non-true (zero)" class="auto-link"><code>OP_VERIFY</code></a> (not shown).</p>
  ...
  case, it checks whether the <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hash</a> generated from the full
  <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a> Bob provided equals the <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hash</a> Alice provided when
...
Bitcoin <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a> and there was no standard way to communicate them
...
hash</a> to Alice. Alice creates a P2SH-style <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> containing
...
<a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a> ensures the full <a href="/en/glossary/redeem-script" title="A script similar in function to a pubkey script. One copy of it is hashed to create a P2SH address (used in an actual pubkey script) and another copy is placed in the spending signature script to enforce its conditions." class="auto-link">redeem script hashes</a> to the same
value as the <a href="/en/glossary/redeem-script" title="A script similar in function to a pubkey script. One copy of it is hashed to create a P2SH address (used in an actual pubkey script) and another copy is placed in the spending signature script to enforce its conditions." class="auto-link">script hash</a> Alice put in her <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>; it then processes the
...
Bob spend the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> if the <a href="/en/glossary/redeem-script" title="A script similar in function to a pubkey script. One copy of it is hashed to create a P2SH address (used in an actual pubkey script) and another copy is placed in the spending signature script to enforce its conditions." class="auto-link">redeem script</a> does not return false.</p>

  <p><img src="/img/dev/en-unlocking-p2sh-output.svg" alt="Unlocking A P2SH Output For Spending" /></p>

  <p>The hash of the <a href="/en/glossary/redeem-script" title="A script similar in function to a pubkey script. One copy of it is hashed to create a P2SH address (used in an actual pubkey script) and another copy is placed in the spending signature script to enforce its conditions." class="auto-link">redeem script</a> has the same properties as a <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey
hash</a>—so it can be transformed into the standard Bitcoin <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> format
with only one small change to differentiate it from a standard <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>.
This makes collecting a P2SH-style <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> as simple as collecting a
P2PKH-style <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>. The hash also obfuscates any <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a> in the
<a href="/en/glossary/redeem-script" title="A script similar in function to a pubkey script. One copy of it is hashed to create a P2SH address (used in an actual pubkey script) and another copy is placed in the spending signature script to enforce its conditions." class="auto-link">redeem script</a>, so P2SH scripts are as secure as P2PKH <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hashes</a>.</p>
...
by <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> not using the default Bitcoin Core settings. If they are
...
or multiple Bitcoin <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a>.</p>
...
provided. Both <em>m</em> and <em>n</em> should be <a href="/en/glossary/op-code" title="Operation codes from the Bitcoin Script language which push data or perform functions within a pubkey script or signature script." class="auto-link">opcodes</a> <code>OP_1</code> through <code>OP_16</code>,
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p><a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">Pubkey</a> <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> are a simplified form of the <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">P2PKH pubkey script</a>,
but they aren’t as
...
if possible.</p>
  ...
  <p><a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">Consensus rules</a> allow null data <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> up to the maximum allowed <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey
...
rules</a>, such as not having any data pushes larger than 520 bytes.</p>
  ...
  <p>Bitcoin Core 0.9.x to 0.10.x will, by default, relay and <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mine</a> <a href="/en/glossary/null-data-transaction" title="A transaction type relayed and mined by default in Bitcoin Core 0.9.0 and later that adds arbitrary data to a provably unspendable pubkey script that full nodes don't have to store in their UTXO database." class="auto-link">null data
transactions</a> with up to 40 bytes in a single data push and only one null
data <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> that pays exactly 0 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>:</p>
...
exactly 0 satoshis.</p>
  ...
  <p>The <code>-datacarriersize</code> Bitcoin Core configuration option allows you to
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>If you use anything besides a standard <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey script</a> in an <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>, <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a>
and <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> using the default Bitcoin Core settings will neither
accept, broadcast, nor <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mine</a> your transaction. When you try to broadcast
your transaction to a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> running the default settings, you will
receive an error.</p>
...
reserved for future <a href="/en/glossary/soft-fork" title="A softfork is a change to the bitcoin protocol  wherein only previously valid blocks/transactions  are made invalid. Since old nodes will recognise  the new blocks as valid, a softfork is backward-compatible." class="auto-link">soft forks</a> and can only be relayed or mined by <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>
...
<a href="/en/glossary/standard-transaction" title="A transaction that passes Bitcoin Core's IsStandard() and IsStandardTx() tests. Only standard transactions are mined or broadcast by peers running the default Bitcoin Core software." class="auto-link">standard transactions</a> which make the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> sent to them unspendable.</p>
...
times larger than a typical single-<a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a>, single-<a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> P2PKH
transaction.</p>
    </li>
    <li>
...
<a href="/en/glossary/op-code" title="Operation codes from the Bitcoin Script language which push data or perform functions within a pubkey script or signature script." class="auto-link">opcodes</a> which solely push data to the stack.</p>
    ...
    <li>
      <p>The transaction must not include any <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> which receive fewer than
1/3 as many <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> as it would take to spend it in a typical <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a>.
...
P2PKH or <a href="/en/glossary/p2sh-address" title="A Bitcoin payment address comprising a hashed script, allowing the spender to create a standard pubkey script that Pays To Script Hash (P2SH). The script can be almost any valid pubkey script." class="auto-link">P2SH output</a> on a Bitcoin Core <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> with the default <a href="/en/glossary/minimum-relay-fee" title="The minimum transaction fee a transaction must pay (if it isn't a high-priority transaction) for a full node to relay that transaction to other nodes. There is no one minimum relay fee---each node chooses its own policy." class="auto-link">relay fee</a>.
Exception: standard null data <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> must receive zero <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
    </li>
  </ul>
...
currently available:</p>
  ...
  <ul>
    <li>
      <p><a href="/en/glossary/sighash-all" title="Default signature hash type which signs the entire transaction except any signature scripts, preventing modification of the signed parts." id="term-sighash-all" class="term"><code>SIGHASH_ALL</code></a>, the default, signs all the <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a> and <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>,
protecting everything except the <a href="/en/glossary/signature-script" title="Data generated by a spender which is almost always used as variables to satisfy a pubkey script. Signature Scripts are called scriptSig in code." class="auto-link">signature scripts</a> against modification.</p>
    ...
    <li>
      <p><a href="/en/glossary/sighash-none" title="Signature hash type which only signs the inputs, allowing anyone to change the outputs however they'd like." id="term-sighash-none" class="term"><code>SIGHASH_NONE</code></a> signs all of the <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a> but none of the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>,
allowing anyone to change where the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> are going unless other
<a href="/en/glossary/signature" title="A value related to a public key which could only have reasonably been created by someone who has the private key that created that public key. Used in Bitcoin to authorize spending satoshis previously sent to a public key." class="auto-link">signatures</a> using other <a href="/en/glossary/signature-hash" title="A flag to Bitcoin signatures that indicates what parts of the transaction the signature signs.  (The default is SIGHASH_ALL.) The unsigned parts of the transaction may be modified." class="auto-link">signature hash</a> flags protect the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>.</p>
    </li>
    <li>
...
the only <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> signed is the one corresponding to this <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a> (the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>
...
of the transaction. The corresponding <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> must exist or the value “1” will
...
pay) flag, creating three new combined types:</p>
  ...
  <ul>
    <li>
      <p><a href="/en/glossary/sighash-anyonecanpay" title="A signature hash type which signs only the current input." class="auto-link"><code>SIGHASH_ALL|SIGHASH_ANYONECANPAY</code></a> signs all of the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> but only
...
<a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a>, so anyone can contribute additional <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> but they cannot
change how many <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> are sent nor where they go.</p>
    </li>
    <li>
      <p><a href="/en/glossary/sighash-anyonecanpay" title="A signature hash type which signs only the current input." class="auto-link"><code>SIGHASH_NONE|SIGHASH_ANYONECANPAY</code></a> signs only this one <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a> and
allows anyone to add or remove other <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a> or <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>, so anyone who
gets a copy of this <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a> can spend it however they’d like.</p>
    ...
    <li>
      <p><a href="/en/glossary/sighash-anyonecanpay" title="A signature hash type which signs only the current input." class="auto-link"><code>SIGHASH_SINGLE|SIGHASH_ANYONECANPAY</code></a> signs this one <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a> and its
corresponding <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>. Allows anyone to add or remove other <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a>.</p>
    </li>
  </ul>
...
the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> without consulting the <code>NONE</code> signer—but nobody else can
...
will accept.</p>
  ...
  <p>As of Bitcoin Core 0.9, a <a href="/en/glossary/minimum-relay-fee" title="The minimum transaction fee a transaction must pay (if it isn't a high-priority transaction) for a full node to relay that transaction to other nodes. There is no one minimum relay fee---each node chooses its own policy." id="term-minimum-fee" class="term">minimum fee</a> (currently 1,000 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>) has been required to
broadcast a transaction across the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>. Any transaction paying only the <a href="/en/glossary/minimum-relay-fee" title="The minimum transaction fee a transaction must pay (if it isn't a high-priority transaction) for a full node to relay that transaction to other nodes. There is no one minimum relay fee---each node chooses its own policy." class="auto-link">minimum fee</a>
...
for why this could be important.</p>
  ...
  <p>Since each transaction spends Unspent Transaction <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">Outputs</a> (<a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a>) and
...
so most transactions include a <a href="/en/glossary/change-address" title="An output in a transaction which returns satoshis to the spender, thus preventing too much of the input value from going to transaction fees." class="auto-link">change output</a>.</p>
  ...
  <p><a href="/en/glossary/change-address" title="An output in a transaction which returns satoshis to the spender, thus preventing too much of the input value from going to transaction fees." id="term-change-output" class="term">Change outputs</a> are regular <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> which spend the surplus <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
from the <a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a> back to the spender.  They can reuse the same P2PKH <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hash</a>
...
outputs</a> be sent to a new P2PKH or <a href="/en/glossary/p2sh-address" title="A Bitcoin payment address comprising a hashed script, allowing the spender to create a standard pubkey script that Pays To Script Hash (P2SH). The script can be almost any valid pubkey script." class="auto-link">P2SH address</a>.</p>
...
spend their <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
...
described below, with more general attacks hypothesized).</p>
  ...
  <ol>
    <li>
      <p>Unique (non-reused) P2PKH and <a href="/en/glossary/p2sh-address" title="A Bitcoin payment address comprising a hashed script, allowing the spender to create a standard pubkey script that Pays To Script Hash (P2SH). The script can be almost any valid pubkey script." class="auto-link">P2SH addresses</a> protect against the first
...
first time <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> sent to those <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a> are spent, so attacks
...
users from reusing <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a>. If your application needs to provide a
...
when the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> from a transaction is spent before that transaction is
...
especially if large amounts of <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> are at stake.</p>
...
<a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> that the lost transaction used as <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a>.</p>
  ...
  <div class="subhead-links sourcefile" data-sourcefile="_data/devdocs/en/guides/contracts.md"><a href="https://github.com/umkoin/umkoin.org/edit/master/_data/devdocs/en/guides/contracts.md">Редагувати</a>
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/guides/contracts.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/guides/contracts.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development#devcommunities">Обговорити</a>
...
help ensure Charlie gets his merchandise and Bob gets his payment.</p>
  ...
  <p>A simple contract could say that Charlie will spend <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to an
...
contract</a>. Charlie spends his <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
to an <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> which can only be spent if two of the three people sign the
...
who should get the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> if there’s a dispute.</p>
...
so she creates and signs a transaction with two <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>, one that spends 60%
of the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to Bob’s <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a> and one that spends the remaining
...
<a href="/en/developer-reference#term-op-checkmultisig" title="Opcode which returns true if one or more provided signatures (m) sign the correct parts of a transaction and match one or more provided public keys (n)"><code>OP_CHECKMULTISIG</code></a> for details.)</p>
  ...
  <p>When the transaction is broadcast to the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, each <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> checks the
<a href="/en/glossary/signature-script" title="Data generated by a spender which is almost always used as variables to satisfy a pubkey script. Signature Scripts are called scriptSig in code." class="auto-link">signature script</a> against the <a href="/en/glossary/p2sh-address" title="A Bitcoin payment address comprising a hashed script, allowing the spender to create a standard pubkey script that Pays To Script Hash (P2SH). The script can be almost any valid pubkey script." class="auto-link">P2SH output</a> Charlie previously paid,
...
validates, the two transaction <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> show up in Bob’s and Charlie’s
...
agree to, such as spending all the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to herself, Bob and Charlie
can find a new arbitrator and sign a transaction spending the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
...
him thousands of <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> in <a href="/en/glossary/transaction-fee" title="The amount remaining when the value of all outputs in a transaction are subtracted from all inputs in a transaction; the fee is paid to the miner who includes that transaction in a block." class="auto-link">transaction fees</a>, so Alice suggests they use a
...
The first transaction pays 100 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a> to a <a href="/en/glossary/p2sh-address" title="A Bitcoin payment address comprising a hashed script, allowing the spender to create a standard pubkey script that Pays To Script Hash (P2SH). The script can be almost any valid pubkey script." class="auto-link">P2SH output</a> whose
...
Broadcasting this transaction would let Alice hold the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a>
hostage, so Bob keeps this transaction private for now and creates a
second transaction.</p>

  <p>The second transaction spends all of the first transaction’s <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a>
...
to expire before further spending his <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a>. Bob hasn’t actually
...
full <a href="/en/developer-guide#issuing-refunds" title="A transaction which refunds some or all satoshis received in a previous transaction" class="auto-link">refund</a>.</p>
  ...
  <p>Now, when Alice does some work worth 1 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoin</a>, she asks Bob to create
...
transaction spends 1 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoin</a> to Alice and the other 99 back to Bob; it does
...
two transactions, Alice could hold Bob’s 100 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a> hostage even if she
...
can each easily track those <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to learn what Bitcoin
<a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a> she pays, how much she pays them, and possibly how many
<a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> she has left.</p>

  <p>Alice isn’t a criminal, she just wants plausible deniability about
where she has spent her <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and how many she has left, so she
...
agree to transfer <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> between each other so no one besides them
can reliably determine who controls which <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.  But they’re faced
with a dilemma: who transfers their <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to one of the other two
...
of them can steal the others’ <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
...
<a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">Outputs</a> (<a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a>) for 100 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a> they can spend. They then each generate
a brand new <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a> and give <a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a> details and <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hashes</a> to the
facilitator.  In this case, the facilitator is AnonGirl; she creates
a transaction spending each of the <a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a> to three equally-sized <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>.
One <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> goes to each of the contributors’ <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hashes</a>.</p>
...
change the <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a> or <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> details.  She gives the partially-signed
...
the transaction to the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>, mixing all of the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a> in
...
which <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>, so they can each spend their <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> with plausible
deniability.</p>
...
were actually made by Alice.</p>
  ...
  <p>The complete history of Alice’s <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> is still in the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>,
so a determined investigator could talk to the people AnonGirl
CoinJoined with to find out the ultimate origin of her <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and
...
amount of <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to pay the <a href="/en/glossary/transaction-fee" title="The amount remaining when the value of all outputs in a transaction are subtracted from all inputs in a transaction; the fee is paid to the miner who includes that transaction in a block." class="auto-link">transaction fee</a>.  An alternative
technique, purchaser CoinJoin, can actually save them <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and
improve their privacy at the same time.</p>

  <p>AnonGirl waits in the IRC chatroom until she wants to make a purchase.
She announces her intention to spend <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and waits until someone
else wants to make a purchase, likely from a different merchant. Then
they combine their <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number.  The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a> the same way as before but set the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>
to the separate merchant <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a> so nobody will be able to figure
...
saving each one of them a tiny amount of <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
...
license.</p>
  ...
  <div class="subhead-links sourcefile" data-sourcefile="_data/devdocs/en/guides/wallets.md"><a href="https://github.com/umkoin/umkoin.org/edit/master/_data/devdocs/en/guides/wallets.md">Редагувати</a>
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/guides/wallets.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/guides/wallets.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development#devcommunities">Обговорити</a>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Permitting receiving and spending of <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> is the only essential
...
program distributing <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a> in order to receive <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and
another program signing transactions spending those <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
...
with the actual <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a> only being distributed when the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>
...
distribute those <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a> as necessary, monitors for <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> spent to
...
<a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
...
keys</a>, optionally helps distribute them, monitors for <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> spent to
those <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a>, creates unsigned transactions spending those <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>,
...
(particularly the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> details) using the signing-only <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a>.</p>
...
<a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a> to receive payment. When ready to spend <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, fill in
...
review the <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> details to make sure they spend the correct
amount to the correct <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>. This prevents malware on the online
...
broadcast it to the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>.</p>
    </li>
  </ol>
...
transactions before signing, the user’s <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> are safe even if the
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p><a href="/en/glossary/private-key" title="The private portion of a keypair which can create signatures that other people can verify using the public key." class="auto-link">Private keys</a> are what are used to unlock <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> from a particular <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>. In Bitcoin, a <a href="/en/glossary/private-key" title="The private portion of a keypair which can create signatures that other people can verify using the public key." class="auto-link">private key</a> in standard format is simply a 256-bit number, between the values:</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <ol>
    ...
    <li>
      <p>Add a 0x80 byte in front of it for <a href="/en/glossary/mainnet" title="The original and main network for Bitcoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a> <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a> or 0xef for <a href="/en/glossary/testnet" title="A global testing environment in which developers can obtain and spend satoshis that have no real-world value on a network that is very similar to the Bitcoin mainnet." class="auto-link">testnet</a> <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a>.</p>
    </li>
    <li>
...
it is used with uncompressed <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a>.</p>
    ...
    <li>
      <p>Convert the result from a byte string into a <a href="/en/glossary/base58check" title="The method used in Bitcoin for converting 160-bit hashes into P2PKH and P2SH addresses.  Also used in other parts of Bitcoin, such as encoding private keys for backup in WIP format.  Not the same as other base58 implementations." class="auto-link">Base58</a> string using <a href="/en/glossary/base58check" title="The method used in Bitcoin for converting 160-bit hashes into P2PKH and P2SH addresses.  Also used in other parts of Bitcoin, such as encoding private keys for backup in WIP format.  Not the same as other base58 implementations." class="auto-link">Base58Check</a> encoding.</p>
    </li>
  </ol>

  <p>The process is easily reversible, using the <a href="/en/glossary/base58check" title="The method used in Bitcoin for converting 160-bit hashes into P2PKH and P2SH addresses.  Also used in other parts of Bitcoin, such as encoding private keys for backup in WIP format.  Not the same as other base58 implementations." class="auto-link">Base58</a> decoding function, and removing the padding.</p>
...
the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> space used to store <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a> for every spent <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>,
...
works with two different <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">P2PKH addresses</a>.   This also means that the key
...
matches the hash in the previous <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output’s</a> <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey script</a>.</p>
...
point (the <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a>):</p>
  ...
  <p>Because of the way <a href="/en/developer-guide#term-point-function" title="The ECDSA function used to create a public key from a private key" class="auto-link"><code>point()</code></a> works, it’s possible to create a <a href="/en/glossary/child-key" title="In HD wallets, a key derived from a parent key.  The key can be either a private key or a public key, and the key derivation may also require a chain code." id="term-child-public-key" class="term">child
...
seemingly-random 256 bits on the righthand side of the hash <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> are
...
lefthand side of the hash <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> are used as the integer value to be combined
...
encrypted, new keys are only generated while the <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> is unlocked.)</p>
  ...
  <div class="subhead-links sourcefile" data-sourcefile="_data/devdocs/en/guides/payment_processing.md"><a href="https://github.com/umkoin/umkoin.org/edit/master/_data/devdocs/en/guides/payment_processing.md">Редагувати</a>
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/guides/payment_processing.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/guides/payment_processing.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development#devcommunities">Обговорити</a>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Because of exchange rate variability between <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and national
...
in <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, necessitating a price conversion.</p>
...
current general market value of <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, or the applications could
accept too few <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> for the product or service being sold.
Alternatively, they could ask for too many <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, driving away potential
spenders.</p>
...
spend any <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> received today.</p>
...
order totals from <a href="/en/developer-guide#term-fiat" title="National currencies such as the dollar or euro" class="auto-link">fiat</a> into <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
...
that <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> will drop in price. Most widely-used payment processing
...
<a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>, or acquire an <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> from another program such as
Bitcoin Core.  Bitcoin <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a> are described in detail in the
...
<a href="/en/glossary/payment-protocol" title="The protocol defined in BIP70 (and other BIPs) which lets spenders get signed payment details from receivers." class="auto-link">payment requests</a>:</p>
  ...
  <p>Using a separate <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> for each incoming payment makes it trivial to
...
request</a> and the <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> used in it, and then scan the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> for
transactions matching that <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>.</p>

  <p>The next subsections will describe in detail the following four
compatible ways to give the spender the <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> and amount to be paid.
...
<a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> and amount into a payment screen. This is, of course,
...
with the attacker’s <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>.</p>
...
the <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>, the amount, and the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">denomination</a>. An expiration time for
...
You must pay by: 2014-04-01 at 23:00 UTC
  ...
  <p>Indicating the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">denomination</a> is critical. As of this writing, popular
Bitcoin <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> software defaults to denominating amounts in either <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">bitcoins</a> (BTC)
, <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a> (mBTC) or <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">microbitcoins</a> (uBTC, “bits”). Choosing between each unit is widely supported,
but other software also lets its users select <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">denomination</a> amounts from
some or all of the following options:</p>

  <table>
    <thead>
      <tr>
        <th><a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">Bitcoins</a></th>
    ...
    <tbody>
      ...
      <tr>
        <td>0.001</td>
        <td><a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoin</a> (mBTC)</td>
      </tr>
      <tr>
        <td>0.000001</td>
        <td><a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">microbitcoin</a> (uBTC, “bits”)</td>
      </tr>
      <tr>
        <td>0.00000001</td>
        <td><a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshi</a></td>
      </tr>
    </tbody>
  </table>
...
information to the spender. An example:</p>
  ...
  <p>Only the <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> is required, and if it is the only thing
...
decimal <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">bitcoins</a> (BTC).</p>
...
images, or in videos. Most mobile Bitcoin <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> apps, and some desktop
...
and offline NFC or Bluetooth-based payments.</p>
  ...
  <p>Instead of being asked to pay a meaningless <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>, such as
...
the spender’s Bitcoin <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> program on the URI.</p>
...
shipping <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>.</p>
    </li>
    <li>
      <p>An order total in <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, perhaps created by converting prices in
<a href="/en/developer-guide#term-fiat" title="National currencies such as the dollar or euro" class="auto-link">fiat</a> to prices in <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
    </li>
    <li>
...
will be a P2PKH or <a href="/en/glossary/p2sh-address" title="A Bitcoin payment address comprising a hashed script, allowing the spender to create a standard pubkey script that Pays To Script Hash (P2SH). The script can be almost any valid pubkey script." class="auto-link">P2SH pubkey script</a> containing a unique (never
...
URL contains the <a href="/en/glossary/p2pkh-address" title="A Bitcoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">P2PKH address</a>:
...
following information:</p>
  ...
  <ul>
    <li>
      <p>The amount of the order in <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and the <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey script</a> to be paid.</p>
    </li>
    <li>
      <p>A memo containing the list of items ordered, so Charlie knows what
he’s paying for.  It may also include Charlie’s mailing <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> so he can
double-check it.</p>
    </li>
    <li>
...
Bob will read it.)</p>
    ...
    <li>
      <p>A <a href="/en/developer-guide#issuing-refunds" title="A transaction which refunds some or all satoshis received in a previous transaction" class="auto-link">refund</a> <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> (<a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey script</a>) which Bob can pay if he needs to
return some or all of Charlie’s <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
    </li>
  </ul>

  <p>Bob’s server receives the Payment message, verifies the transaction pays
the requested amount to the <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> provided, and then broadcasts the
...
number of <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> for goods specified in the memo field.</p>
    </li>
    <li>
...
Bob was paid the specified number of <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
    </li>
  </ul>
...
trusted without risk analysis. Although <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> usually confirm the first 
...
expensive <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> equipment.</p>
...
For example, the <a href="/en/developer-reference#listunspent" class="auto-link"><code>listunspent</code> RPC</a> provides an array of every <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshi</a> you can 
...
connecting to large numbers of Bitcoin <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> to track how transactions and 
...
estimate the amount of time until they’re added to a <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>.</p>
  ...
  <p>Another example could be to detect a <a href="/en/glossary/fork" title="When two or more blocks have the same block height, forking the block chain.  Typically occurs when two or more miners find blocks at nearly the same time.  Can also happen as part of an attack." class="auto-link">fork</a> when multiple <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> report differing 
...
to return the <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to the <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey script</a> from which they came.
For example:</p>

  <ul>
    <li>
      <p>Alice wants to buy a widget from Bob, so Bob gives Alice a price and
Bitcoin <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>.</p>
    </li>
    <li>
      <p>Alice opens her <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> program and sends some <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to that
<a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>. Her <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> program automatically chooses to spend those
<a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> from one of its unspent <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>, an <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> corresponding to
the Bitcoin <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> mjSk1Ny9spzU2fouzYgLqGUD8U41iR35QN.</p>
    </li>
    <li>
      <p>Bob discovers Alice paid too many <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>. Being an honest fellow,
Bob <a href="/en/developer-guide#issuing-refunds" title="A transaction which refunds some or all satoshis received in a previous transaction" class="auto-link">refunds</a> the extra <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to the mjSk… <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>.</p>
    </li>
  </ul>

  <p>This seems like it should work, but Alice is using a centralized
multi-user <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">web wallet</a> which doesn’t give <a href="/en/developer-guide#term-unique-address" title="Address which are only used once to protect privacy and increase security" class="auto-link">unique addresses</a> to each user,
...
for the <code>refund_to</code> <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Many receivers worry that their <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> will be less valuable in the
...
at <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> data to figure out how many <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> the receiver has
earned, spent, and saved.</p>
    </li>
    <li>
      <p>A last-in-first-out (LIFO) algorithm spends newly acquired <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
...
possibly bad for their reputation.</p>
    ...
    <li>
      <p>A first-in-first-out (FIFO) algorithm spends the oldest <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>When a receiver receives <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> in an <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>, the spender can track
(in a crude way) how the receiver spends those <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>. But the spender
can’t automatically see other <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> paid to the receiver by other
...
transaction.</p>
  ...
  <p>However, if the receiver spends <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> from two different spenders in
...
<a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>, the easier it is for an outsider to track how many <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> the
receiver has earned, spent, and saved.</p>

  <p><a href="/en/developer-guide#term-merge-avoidance" title="A strategy for selecting which outputs to spend that avoids merging outputs with different histories that could leak private information" id="term-merge-avoidance" class="term">Merge avoidance</a> means trying to avoid spending unrelated <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> in the
...
smallest <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> you have which is larger than the amount being
requested. For example, if you have four <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> holding, respectively,
100, 200, 500, and 900 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, you would pay a bill for 300 <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
with the 500-<a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshi</a> <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>. This way, as long as you have <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>
...
intelligently distributing their payments among multiple <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>
...
<a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">confirmed</a>. Since recent <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> are at the greatest risk of being
<a href="/en/glossary/double-spend" title="A transaction that uses the same input as an already broadcast transaction. The attempt of duplication, deceit, or conversion,  will be adjudicated when only one of the transactions is recorded in the blockchain." class="auto-link">double-spent</a>, spending them before older <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> allows the spender to
hold on to older <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">confirmed</a> <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> which are much less likely to be
...
six <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">confirmations</a> whether you spend old <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> or new <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a>.</p>
...
diminishing returns is reached. The <a href="https://umkoin.org/en/bitcoin-paper">original Bitcoin paper</a>
...
older <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> may be eligible for inclusion in the 50,000 bytes set
aside for no-fee-required <a href="/en/glossary/high-priority-transaction" title="Transactions that don't have to pay a transaction fee because their inputs have been idle long enough to accumulated large amounts of priority.  Note: miners choose whether to accept free transactions." class="auto-link">high-priority transactions</a> by <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> running the default Bitcoin Core
...
centralized server which handles <a href="/en/glossary/denominations" title="Denominations of Bitcoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> on behalf of its spenders. In
...
features may allow some <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> programs to manage a list of recurring
...
chance receivers get paid on time.</p>
  ...
  <div class="subhead-links sourcefile" data-sourcefile="_data/devdocs/en/guides/operating_modes.md"><a href="https://github.com/umkoin/umkoin.org/edit/master/_data/devdocs/en/guides/operating_modes.md">Редагувати</a>
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/guides/operating_modes.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/guides/operating_modes.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development#devcommunities">Обговорити</a>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Currently there are two primary methods of validating the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> as a client: Full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> and <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV clients</a>. Other methods, such as server-trusting methods, are not discussed as they are not recommended.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>First, while the <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV client</a> can not be easily fooled into thinking a transaction is in a <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> when it is not, the reverse is not true. A <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">full node</a> can simply lie by omission, leading an <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV client</a> to believe a transaction has not occurred. This can be considered a form of Denial of Service. One mitigation strategy is to connect to a number of full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>, and send the requests to each <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>. However this can be defeated by <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> partitioning or Sybil attacks, since identities are essentially free, and can be bandwidth intensive. Care must be taken to ensure the client is not cut off from honest <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>.</p>

  <p>Second, the <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV client</a> only requests transactions from full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> corresponding to keys it owns. If the <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV client</a> downloads all <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> and then discards unneeded ones, this can be extremely bandwidth intensive. If they simply ask full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> for <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> with specific transactions, this allows full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> a complete view of the public <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a> that correspond to the user. This is a large privacy leak, and allows for tactics such as denial of service for clients, users, or <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Bitcoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a> that are disfavored by those running full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>, as well as trivial linking of funds. A client could simply spam many fake transaction requests, but this creates a large strain on the <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV client</a>, and can end up defeating the purpose of <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">thin clients</a> altogether.</p>
...
scripts</a> and <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey scripts</a>, and more. This enables P2SH transaction finding.</p>
  ...
  <p>If a user is more privacy-conscious, he can set the <a href="/en/glossary/bloom-filter" title="A filter used primarily by SPV clients to request only matching transactions and merkle blocks from full nodes." class="auto-link">Bloom filter</a> to include more false positives, at the expense of extra bandwidth used for transaction discovery. If a user is on a tight bandwidth budget, he can set the false-positive rate to low, knowing that this will allow full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> a clear view of what transactions are associated with his client.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>There are future proposals such as Unspent Transaction <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">Output</a> (<a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a>) commitments in the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> to find a more satisfactory middle-ground for clients between needing a complete copy of the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>, or trusting that a majority of your connected <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> are not lying. <a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a> commitments would enable a very secure client using a finite amount of storage using a data structure that is authenticated in the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>. These type of proposals are, however, in very early stages, and will require <a href="/en/glossary/soft-fork" title="A softfork is a change to the bitcoin protocol  wherein only previously valid blocks/transactions  are made invalid. Since old nodes will recognise  the new blocks as valid, a softfork is backward-compatible." class="auto-link">soft forks</a> in the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>.</p>
  ...
  <div class="subhead-links sourcefile" data-sourcefile="_data/devdocs/en/guides/p2p_network.md"><a href="https://github.com/umkoin/umkoin.org/edit/master/_data/devdocs/en/guides/p2p_network.md">Редагувати</a>
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/guides/p2p_network.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/guides/p2p_network.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development#devcommunities">Обговорити</a>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>The Bitcoin <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> protocol allows full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>
(<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a>) to collaboratively maintain a
<a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" id="term-network" class="term">peer-to-peer network</a> for <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> and
transaction exchange. Full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> download and verify every <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> and transaction
prior to relaying them to other <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>. Archival <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> are full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> which
store the entire <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">blockchain</a> and can serve historical <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> to other <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>.
Pruned <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> are full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> which do not store the entire <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">blockchain</a>. Many <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV 
clients</a> also use the Bitcoin <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> protocol to connect to full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>.</p>
...
<a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV</a>-level security.</p>
  ...
  <p>To provide practical examples of the Bitcoin <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>, this
section uses Bitcoin Core as a representative <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">full node</a> and <a href="http://bitcoinj.github.io">BitcoinJ</a>
...
in the example <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> below have been replaced with <a href="http://tools.ietf.org/html/rfc5737">RFC5737</a> reserved
IP addresses.</p>
...
addresses of any active full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>. In order to discover some IP
...
A records</a> with the IP addresses of full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> that may accept new
...
[...]
  ...
  <p>The <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Bitcoin network to assist in peer discovery." class="auto-link">DNS seeds</a> are maintained by Bitcoin community members: some of them
provide dynamic <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Bitcoin network to assist in peer discovery." class="auto-link">DNS seed</a> servers which automatically get IP addresses
of active <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> by scanning the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>; others provide static <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Bitcoin network to assist in peer discovery." class="auto-link">DNS
seeds</a> that are updated manually and are more likely to provide IP
addresses for inactive <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>. In either case, <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> are added to the
<a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Bitcoin network to assist in peer discovery." class="auto-link">DNS seed</a> if they run on the default Bitcoin ports of 8333 for <a href="/en/glossary/mainnet" title="The original and main network for Bitcoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a>
or 18333 for <a href="/en/glossary/testnet" title="A global testing environment in which developers can obtain and spend satoshis that have no real-world value on a network that is very similar to the Bitcoin mainnet." class="auto-link">testnet</a>.</p>

  <p><a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Bitcoin network to assist in peer discovery." class="auto-link">DNS seed</a> results are not authenticated and a malicious seed operator or
<a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> <a href="https://en.wikipedia.org/wiki/Man-in-the-middle_attack" class="auto-link">man-in-the-middle</a> attacker can return only IP addresses of
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> controlled by the attacker, isolating a program on the attacker’s
own <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> and allowing the attacker to feed it bogus transactions and
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>.  For this reason, programs should not rely on <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Bitcoin network to assist in peer discovery." class="auto-link">DNS seeds</a>
exclusively.</p>

  <p>Once a program has connected to the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, its <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> can begin to send
it <code>addr</code>
(address) messages with the IP addresses and port numbers of
other <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> on the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, providing a fully decentralized method of
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> discovery. Bitcoin Core keeps a record of known <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> in a
persistent on-disk database which usually allows it to connect directly
to those <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> on subsequent startups without having to use <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Bitcoin network to assist in peer discovery." class="auto-link">DNS seeds</a>.</p>

  <p>However, <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> often leave the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> or change IP addresses, so
...
<a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, forcing a user to wait before sending a transaction or checking
the status of payment.</p>

  <p>To avoid this possible delay, <a href="http://bitcoinj.github.io" class="auto-link">BitcoinJ</a> always uses dynamic <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Bitcoin network to assist in peer discovery." class="auto-link">DNS seeds</a> to
get IP addresses for <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> believed to be currently active.
Bitcoin Core also tries to strike a balance between minimizing delays
and avoiding unnecessary <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Bitcoin network to assist in peer discovery." class="auto-link">DNS seed</a> use: if Bitcoin Core has entries in
its <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> database, it spends up to 11 seconds attempting to connect to
...
addresses and port numbers to several dozen <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> which were active
around the time that particular version of the software was first
released. Bitcoin Core will start attempting to connect to these <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>
if none of the <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Bitcoin network to assist in peer discovery." class="auto-link">DNS seed</a> servers have responded to a query within 60
...
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> from a specific <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> by IP address, or to make a persistent
connection to a specific <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> by IP address.  See the <code>-help</code> text for
...
seeds used by Bitcoin Core and <a href="http://bitcoinj.github.io" class="auto-link">BitcoinJ</a>. The Bitcoin Core <a href="https://github.com/bitcoin/bitcoin/blob/master/doc/dnsseed-policy.md">DNS Seed
Policy</a>.  The hardcoded list of IP addresses used by Bitcoin Core and
<a href="http://bitcoinj.github.io" class="auto-link">BitcoinJ</a> is generated using the <a href="https://github.com/bitcoin/bitcoin/tree/master/contrib/seeds">makeseeds script</a>.</p>
...
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>. The remote <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> responds with its own <a href="/en/developer-reference#version" title="A P2P network message sent at the begining of a connection to allow protocol version negotiation" class="auto-link"><code>version</code> message</a>. Then both
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> send a <a href="/en/developer-reference#verack" title="A P2P network message sent in reply to a version message to confirm a connection has been established" class="auto-link"><code>verack</code> message</a> to the other <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> to indicate the
connection has been established.</p>

  <p>Once connected, the client can send to the remote <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> <code>getaddr</code> and <a href="/en/developer-reference#addr" title="The P2P network message which relays IP addresses and port numbers of active nodes to other nodes and clients, allowing decentralized peer discovery." class="auto-link"><code>addr</code> messages</a> to gather additional <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a>.</p>

  <p>In order to maintain a connection with a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a>, <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> by default will send a message to <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> before 30 minutes of inactivity. If 90 minutes pass without a message being received by a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a>, the client will assume that connection has closed.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Before a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">full node</a> can validate <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transactions</a> and
...
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> 1 (the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> after the hardcoded <a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." class="auto-link">genesis block</a>) to the current tip
...
downloaded, such as when a previously-caught-up <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> has been offline
for a long time. In this case, a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> can use the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> method to download
...
The goal is to download the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> from the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a> in sequence.</p>
  ...
  <p>The first time a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> is started, it only has a single <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> in its
local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a>—the hardcoded <a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." class="auto-link">genesis block</a> (<a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." class="auto-link">block 0</a>).  This
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> chooses a remote <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a>, called the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>, and sends it the
...
to all zeroes to request a maximum-size response.</p>
  ...
  <p>Upon <a href="/en/developer-guide#term-receipt" title="A cryptographically-verifiable receipt created using parts of a payment request and a confirmed transaction" class="auto-link">receipt</a> of the <a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a>, the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> takes the first
...
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> with that <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hash. It finds that <a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." class="auto-link">block 0</a> matches, so it
replies with 500 <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventories</a> (the maximum response to a
<a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a>) starting from <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> 1. It sends these <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventories</a>
in the <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a> illustrated below.</p>
  ...
  <p><a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">Inventories</a> are unique identifiers for information on the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>. Each
<a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventory</a> contains a type field and the unique identifier for an
...
<a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventories</a> for <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> 1 through 501. (For example, the hash of <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> 1
is 4860…0000 as seen in the illustration above.)</p>

  <p>The <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> uses the received <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventories</a> to request 128 <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> from
the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> in the <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> message</a> illustrated below.</p>

  <p><img src="/img/dev/en-ibd-getdata.svg" alt="First GetData Message Sent During IBD" /></p>

  <p>It’s important to <a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">blocks-first</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> that the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> be requested and
...
the preceding <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. That means the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> can’t fully validate a
...
blocks</a>; a subsection below describes them in more detail.</p>
  ...
  <p>Upon <a href="/en/developer-guide#term-receipt" title="A cryptographically-verifiable receipt created using parts of a payment request and a confirmed transaction" class="auto-link">receipt</a> of the <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> message</a>, the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> replies with each
...
(for <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> 1) is illustrated below.</p>
  ...
  <p>The <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> downloads each <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>, validates it, and then requests the
...
an <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventory</a>, it sends another <a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a> to the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>
requesting the <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventories</a> of up to 500 more <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>.  This second
<a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a> contains multiple <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hashes as illustrated
below:</p>

  <p><img src="/img/dev/en-ibd-getblocks2.svg" alt="Second GetBlocks Message Sent During IBD" /></p>

  <p>Upon <a href="/en/developer-guide#term-receipt" title="A cryptographically-verifiable receipt created using parts of a payment request and a confirmed transaction" class="auto-link">receipt</a> of the second <a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a>, the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> searches
...
two <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> have in common is <a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." class="auto-link">block 0</a> and so it sends an <code>inv</code> starting with
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> 1 (the same <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a> seen several illustrations above).</p>
  ...
  <p>This repeated search allows the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> to send useful <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventories</a> even if
the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node’s</a> local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> forked from the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node’s</a> local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block
...
<a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> gets to the tip of the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>.</p>

  <p>When the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> receives the second <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a>, it will request
those <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> using <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> messages</a>.  The sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> will respond with
<a href="/en/developer-reference#block" title="The P2P network message which sends a serialized block" class="auto-link"><code>block</code> messages</a>.  Then the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> will request more <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventories</a> with
...
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> is synced to the tip of the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>.  At that point, the <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>
...
disadvantage is that the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> relies on a single sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> for all
of its downloading. This has several implications:</p>

  <ul>
    <li>
      <p><strong>Speed Limits:</strong> All requests are made to the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>, so if the
sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> has limited upload bandwidth, the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> will have slow
download speeds.  Note: if the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> goes offline, Bitcoin Core
will continue downloading from another <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>—but it will still only
download from a single sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> at a time.</p>
    </li>
    <li>
      <p><strong>Download Restarts:</strong> The sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> can send a non-best (but
otherwise valid) <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> to the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>. The <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> won’t be
...
completion, forcing the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> to restart its <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> download
over again from a different <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>. Bitcoin Core ships with several
...
developers to help an <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> detect that it is being fed an
alternative <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> history—allowing the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> to restart
its download earlier in the process.</p>
    </li>
    <li>
      <p><strong>Disk Fill Attacks:</strong> Closely related to the download restarts, if
the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> sends a non-best (but otherwise valid) <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>, the
chain will be stored on disk, wasting space and possibly filling up
the disk drive with useless data.</p>
    </li>
    <li>
      <p><strong>High Memory Use:</strong> Whether maliciously or by accident, the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>
...
solves several problems with the older <a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">blocks-first IBD</a> method.</p>
  ...
  <p>The first time a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> is started, it only has a single <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> in its
local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a>—the hardcoded <a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." class="auto-link">genesis block</a> (<a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." class="auto-link">block 0</a>).  The
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> chooses a remote <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a>, which we’ll call the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>, and sends it the
<a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code> message</a> illustrated below.</p>
  ...
  <p>In the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hashes field of the <a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code> message</a>, the new <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>
sends the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hash of the only <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> it has, the <a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." class="auto-link">genesis block</a>
(6fe2…0000 in <a href="/en/glossary/internal-byte-order" title="The standard order in which hash digests are displayed as strings---the same format used in serialized blocks and transactions." class="auto-link">internal byte order</a>).  It also sets the stop hash field
to all zeroes to request a maximum-size response.</p>

  <p>Upon <a href="/en/developer-guide#term-receipt" title="A cryptographically-verifiable receipt created using parts of a payment request and a confirmed transaction" class="auto-link">receipt</a> of the <a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code> message</a>, the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> takes the first
(and only) <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hash and searches its local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a> for a
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> with that <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hash. It finds that <a href="/en/glossary/genesis-block" title="The first block in the Bitcoin block chain." class="auto-link">block 0</a> matches, so it
...
illustrated below.</p>
  ...
  <p>The <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> can partially validate these <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block headers</a> by ensuring that
...
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>.)</p>
  ...
  <p>After the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> has partially validated the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block headers</a>, it can do
two things in parallel:</p>

  <ol>
    <li>
      <p><strong>Download More <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">Headers</a>:</strong> the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> can send another <a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code>
message</a> to the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> to request the next 2,000 <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> on the
...
of downloaded data.</p>
      ...
      <p>Once the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> receives a <a href="/en/developer-reference#headers" title="A P2P protocol message containing one or more block headers" class="auto-link"><code>headers</code> message</a> with fewer than 2,000
 <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> from the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>, it sends a <a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code> message</a> to each
 of its outbound <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> to get their view of <a href="/en/glossary/header-chain" title="A chain of block headers with each header linking to the header that preceded it; the most-difficult-to-recreate chain is the best header chain" class="auto-link">best header chain</a>. By
 ...
 its outbound <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a>. This means a dishonest sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> will quickly be
 discovered even if checkpoints aren’t used (as long as the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>
 connects to at least one honest <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a>; Bitcoin Core will continue to
 provide checkpoints in case honest <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> can’t be found).</p>
    </li>
    <li>
      <p><strong>Download <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">Blocks</a>:</strong> While the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> continues downloading
<a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a>, and after the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> finish downloading, the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> will
request and download each <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. The <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> can use the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block
...
messages</a> that request the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> it needs by their <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventory</a>. It
doesn’t need to request these from the sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>—it can request
them from any of its <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">full node</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a>. (Although not all full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a>
...
single sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>.</p>

      <p>To spread the load between multiple <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a>, Bitcoin Core will only
 request up to 16 <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> at a time from a single <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a>. Combined with
 ...
 requested from its sync <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>).</p>
    </li>
  </ol>
...
minimum of two more seconds for the stalling <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> to send the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. If
...
stalling <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> and attempt to connect to another <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>. For example, in
the illustration above, <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">Node</a> A will be disconnected if it doesn’t send
  ...
  <table>
    <tbody>
      ...
      <tr>
        ...
        <td>One or more <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventories</a> derived from <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hashes</td>
        <td>One <a href="/en/glossary/serialized-block" title="A complete block in its binary format---the same format used to calculate total block byte size; often represented using hexadecimal." class="auto-link">serialized block</a></td>
      </tr>
    </tbody>
  </table>
...
the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> sends a <a href="/en/developer-reference#block" title="The P2P network message which sends a serialized block" class="auto-link"><code>block</code> message</a> to each of its <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">full node</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> with
the new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. The <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> can reasonably bypass the standard relay
method in this way because it knows none of its <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> already have the
...
the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a>, acting as a standard relay <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>, sends an <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a> to
each of its <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> (both <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">full node</a> and <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV</a>) with an <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventory</a> referring
to the new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. The most common responses are:</p>
      ...
      <ul>
        <li>
          <p>Each <a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">blocks-first</a> (BF) <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> that wants the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> replies with a
<a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> message</a> requesting the full <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>.</p>
        </li>
        <li>
          <p>Each <a href="/en/glossary/headers-first-sync" title="Synchronizing the block chain by downloading block headers before downloading the full blocks." class="auto-link">headers-first</a> (HF) <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> that wants the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> replies with a
<a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code> message</a> containing the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hash of the
...
<a href="/en/glossary/merkle-block" title="A partial merkle tree connecting transactions matching a bloom filter to the merkle root of a block." class="auto-link">merkle block</a>.</p>
      ...
      <p>The <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> replies to each request accordingly by sending the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>
 in a <a href="/en/developer-reference#block" title="The P2P network message which sends a serialized block" class="auto-link"><code>block</code> message</a>, one or more <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> in a <a href="/en/developer-reference#headers" title="A P2P protocol message containing one or more block headers" class="auto-link"><code>headers</code> message</a>,
 ...
 <a href="/en/developer-reference#tx" title="A P2P protocol message which sends a single serialized transaction" class="auto-link"><code>tx</code> messages</a>.</p>
    ...
    <li>
      <p><strong><a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." id="term-direct-headers-announcement" class="term">Direct Headers Announcement</a>:</strong>
a relay <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> may skip the round trip overhead of an <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a>
...
message</a> containing the full <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> of the new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. A HF <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a>
receiving this message will partially validate the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block header</a> as it
would during <a href="/en/glossary/headers-first-sync" title="Synchronizing the block chain by downloading block headers before downloading the full blocks." class="auto-link">headers-first IBD</a>, then request the full <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> contents
with a <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> message</a> if the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> is valid. The relay <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> then
responds to the <code>getdata</code> request with the full or filtered <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>
data in a <code>block</code> or <a href="/en/developer-reference#merkleblock" title="A P2P protocol message used to request a filtered block useful for SPV proofs" class="auto-link"><code>merkleblock</code> message</a>, respectively. A HF <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>
...
connection handshake.</p>
      ...
      <p>This protocol for <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> broadcasting was proposed in BIP 130 and has
been implemented in Bitcoin Core since version 0.12.</p>
    </li>
  </ul>

  <p>By default, Bitcoin Core broadcasts <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> using direct <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a>
announcement to any <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> that have signalled with <a href="/en/developer-reference#sendheaders" title="A P2P network message used to request new blocks be announced through headers messages rather than inv messages" class="auto-link"><code>sendheaders</code></a> and
uses <a href="/en/developer-guide#term-standard-block-relay" title="The regular block relay method: announcing a block with an inv message and waiting for a response" class="auto-link">standard block relay</a> for all <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> that have not. Bitcoin Core
will accept <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> sent using any of the methods described above.</p>

  <p>Full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> validate the received <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> and then advertise it to their
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> using the <a href="/en/developer-guide#term-standard-block-relay" title="The regular block relay method: announcing a block with an inv message and waiting for a response" class="auto-link">standard block relay</a> method described above.  The condensed
table below highlights the operation of the messages described above
(Relay, BF, HF, and <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV</a> refer to the relay <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>, a <a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">blocks-first</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>, a
<a href="/en/glossary/headers-first-sync" title="Synchronizing the block chain by downloading block headers before downloading the full blocks." class="auto-link">headers-first</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>, and an <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV client</a>; <em>any</em> refers to a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> using any
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> retrieval method.)</p>
  ...
  <table>
    <tbody>
      ...
      <tr>
        <td><strong>Payload</strong></td>
        <td>The <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventory</a> of the new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a></td>
        <td>The <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventory</a> of the new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a></td>
        <td>One or more <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hashes on the HF <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node’s</a> <a href="/en/glossary/header-chain" title="A chain of block headers with each header linking to the header that preceded it; the most-difficult-to-recreate chain is the best header chain" class="auto-link">best header chain</a> (BHC)</td>
        <td>Up to 2,000 <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> connecting HF <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node’s</a> BHC to relay <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node’s</a> BHC</td>
      </tr>
      <tr>
        <td><strong>Message</strong></td>
        <td><a href="/en/developer-reference#block" title="The P2P network message which sends a serialized block"><code>block</code></a></td>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p><a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">Blocks-first</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> may download <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan blocks</a>—<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> whose <a href="/en/developer-reference#term-previous-block-header-hash" title="A field in the block header which contains the SHA256(SHA256()) hash of the previous block's header" class="auto-link">previous
block header hash</a> field refers to a <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block header</a> this <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>
...
the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a>).</p>
  ...
  <p>When a <a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">blocks-first</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> downloads an <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan block</a>, it will not validate
it. Instead, it will send a <a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a> to the <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> which sent
the <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan block</a>; the broadcasting <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> will respond with an <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a>
containing <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Bitcoin P2P network." class="auto-link">inventories</a> of any <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> the downloading <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> is missing (up
to 500); the downloading <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> will request those <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> with a <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code>
message</a>; and the broadcasting <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> will send those <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> with a <a href="/en/developer-reference#block" title="The P2P network message which sends a serialized block" class="auto-link"><code>block</code>
message</a>. The downloading <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> will validate those <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>, and once the
...
the former <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan block</a>.</p>
  ...
  <p><a href="/en/glossary/headers-first-sync" title="Synchronizing the block chain by downloading block headers before downloading the full blocks." class="auto-link">Headers-first</a> <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">nodes</a> avoid some of this complexity by always requesting
<a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block headers</a> with the <a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code> message</a> before requesting a <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>
with the <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> message</a>. The broadcasting <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> will send a <a href="/en/developer-reference#headers" title="A P2P protocol message containing one or more block headers" class="auto-link"><code>headers</code>
...
downloading <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a> needs to reach the tip of the <a href="/en/glossary/header-chain" title="A chain of block headers with each header linking to the header that preceded it; the most-difficult-to-recreate chain is the best header chain" class="auto-link">best header chain</a>; each of
those <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> will point to its parent, so when the downloading <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">node</a>
receives the <a href="/en/developer-reference#block" title="The P2P network message which sends a serialized block" class="auto-link"><code>block</code> message</a>, the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> shouldn’t be an <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>In order to send a transaction to a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a>, an <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a> is sent. If a <code>getdata</code> response message is received, the transaction is sent using <code>tx</code>. The <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> receiving this transaction also forwards the transaction in the same manner, given that it is a valid transaction.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Full <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> may keep track of <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transactions</a> which are eligible to
be included in the next <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. This is essential for <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> who will
actually <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mine</a> some or all of those transactions, but it’s also useful
for any <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> who wants to keep track of <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transactions</a>, such
as <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> serving <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transaction</a> information to <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Bitcoin clients." class="auto-link">SPV clients</a>.</p>
...
pool or mempool. When a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> shuts down, its memory pool is lost except
...
<a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> restart or as they purge some transactions to make room in memory
for others.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Take note that for both types of broadcasting, mechanisms are in place to punish misbehaving <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peers</a> who take up bandwidth and computing resources by sending false information. If a <a href="/en/glossary/node" title="A computer that connects to the Bitcoin network." class="auto-link">peer</a> gets a banscore above the <code>-banscore=&lt;n&gt;</code> threshold, he will be banned for the number of seconds defined by <code>-bantime=&lt;n&gt;</code>, which is 86,400 by default (24 hours).</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Earlier versions of Bitcoin Core allowed developers and trusted community members to issue <a href="https://umkoin.org/en/alerts">Bitcoin alerts</a> to notify users of critical <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>-wide issues. This messaging system <a href="https://umkoin.org/en/alert/2016-11-01-alert-retirement">was retired</a> in Bitcoin Core v0.13.0; however, internal alerts, partition detection warnings and the <code>-alertnotify</code> option features remain.</p>

  <h2 id="mining">Mining</h2>
  <div class="subhead-links sourcefile" data-sourcefile="_data/devdocs/en/guides/mining.md"><a href="https://github.com/umkoin/umkoin.org/edit/master/_data/devdocs/en/guides/mining.md">Редагувати</a>
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/guides/mining.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/guides/mining.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development#devcommunities">Обговорити</a>
...
a higher variance (longer time between payments)</p>
    ...
    <li>
      <p>Pooled <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>, where the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> pools resources with other <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> to
...
<a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> in rough correlation to the amount of hashing power
they each contributed, allowing the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> to receive small
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>As illustrated below, solo <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> typically use <code>bitcoind</code> to get new
transactions from the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>. Their <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software periodically polls
<code>bitcoind</code> for new transactions using the <a href="/en/developer-reference#getblocktemplate" class="auto-link"><code>getblocktemplate</code> RPC</a>, which
...
header</a> nonce and generates the corresponding hash.</p>
  ...
  <p>If none of the hashes are below the threshold, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> hardware gets
an updated <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block header</a> with a new <a href="/en/glossary/merkle-root" title="The root node of a merkle tree, a descendant of all the hashed pairs in the tree.  Block headers must include a valid merkle root descended from all transactions in that block." class="auto-link">merkle root</a> from the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software;
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Pool <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> follow a similar workflow, illustrated below, which allows
<a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool operators to pay <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> based on their share of the work
done. The <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool gets new transactions from the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> using
<code>bitcoind</code>. Using one of the methods discussed later, each <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner’s</a> <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>
...
construct <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block headers</a>.</p>
  ...
  <p>In pooled <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool sets the <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target threshold</a> a few orders
...
<a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> checked a percentage of the possible hash values.</p>

  <p>The <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> then sends to the pool a copy of the information the pool
...
transaction</a> must pay the pool.)</p>
  ...
  <p>The information the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> sends to the pool is called a share because it
proves the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> did a share of the work. By chance, some shares the
pool receives will also be below the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target</a>—the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool
sends these to the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> to be added to the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>.</p>

  <p>The <a href="/en/glossary/block-reward" title="The amount that miners may claim as a reward for creating a block. Equal to the sum of the block subsidy (newly available satoshis) plus the transactions fees paid by transactions included in the block." class="auto-link">block reward</a> and <a href="/en/glossary/transaction-fee" title="The amount remaining when the value of all outputs in a transaction are subtracted from all inputs in a transaction; the fee is paid to the miner who includes that transaction in a block." class="auto-link">transaction fees</a> that come from <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> that <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>
are paid to the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool. The <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool pays out a portion of
these proceeds to individual <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> based on how many shares they generated. For
example, if the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool’s <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target threshold</a> is 100 times lower than
the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target threshold</a>, 100 shares will need to be generated on
average to create a successful <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>, so the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool can pay 1/100th
of its payout for each share received.  Different <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pools use
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>In both solo and pool <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software needs to get the
...
<a href="/en/developer-reference#getwork" class="auto-link"><code>getwork</code> RPC</a>, which constructs a <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> for the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> directly. Since a
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>An improved method is the Bitcoin Core <a href="/en/developer-reference#getblocktemplate" class="auto-link"><code>getblocktemplate</code> RPC</a>. This
provides the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software with much more information:</p>
...
paying the pool or the solo <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner’s</a> <code>bitcoind</code> <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a>.</p>
    </li>
    <li>
      <p>A complete dump of the transactions <code>bitcoind</code> or the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool
suggests including in the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>, allowing the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software to
...
solo <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a>, this is the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target</a>.)</p>
  ...
  <p>Using the transactions received, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software adds a nonce to the
...
Whenever the extra nonce field needs to be changed, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software
rebuilds the necessary parts of the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Bitcoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a> and updates the time and
...
ensure they get the most recent work, most <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> use <a href="https://en.wikipedia.org/wiki/Push_technology#Long_polling">HTTP longpoll</a> to
...
<a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool to push a new <a href="/en/developer-reference#getblocktemplate" class="auto-link"><code>getblocktemplate</code></a> to the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> as soon as any
<a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> on the <a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a> publishes a new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> or the pool
wants to send more transactions to the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software.</p>
...
protocol</a>. Stratum focuses on giving <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> the minimal information they
...
paying the pool.</p>
    ...
    <li>
      <p>The parts of the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Bitcoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a> which need to be re-hashed to
...
updated with a new extra nonce. The other parts of the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Bitcoin, the leaves are almost always transactions from a single block." class="auto-link">merkle
...
<a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block header</a> for the next <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>.</p>
  ...
  <p>Using the <a href="/en/glossary/coinbase-transaction" title="The first transaction in a block.  Always created by a miner, it includes a single coinbase." class="auto-link">coinbase transaction</a> received, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software adds a
...
transaction</a>, and adds the hash to the received parts of the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Bitcoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a>.
...
needs to be changed, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software updates and re-hashes the
...
<a href="/en/glossary/merkle-root" title="The root node of a merkle tree, a descendant of all the hashed pairs in the tree.  Block headers must include a valid merkle root descended from all transactions in that block." class="auto-link">merkle root</a> field.</p>
  ...
  <p>Unlike <a href="/en/developer-reference#getblocktemplate" class="auto-link"><code>getblocktemplate</code></a>, <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> using Stratum cannot inspect or add
transactions to the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> they’re currently <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>. Also unlike
...
so <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> don’t need to use HTTP longpoll to ensure they receive
immediate updates from <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pools when a new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> is broadcast to the
<a href="/en/developer-guide#term-network" title="The Bitcoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>.</p>

      <p><strong>Resources:</strong> The GPLv3 <a href="https://github.com/luke-jr/bfgminer">BFGMiner</a> <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software and AGPLv3
<a href="https://github.com/luke-jr/eloipool">Eloipool</a> <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool software are widely-used among <a href="/en/glossary/mining" title="Mining is the act of creating valid Bitcoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> and
