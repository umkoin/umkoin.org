...
Umkoin and start building Umkoin-based applications, but it is <a href="/en/developer-reference#not-a-specification">not a
specification</a>. To make the best use of
this documentation, you may want to install the current version of Umkoin
Core, either from <a href="https://github.com/umkoin/umkoin">source</a> or from a <a href="/en/download">pre-compiled executable</a>.</p>

  <p>Questions about Umkoin development are best asked in one of the
<a href="/en/development#devcommunities">Umkoin development communities</a>.
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>The <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> provides Umkoin’s public ledger, an ordered and timestamped record
...
and modification of previous transaction records.</p>
  ...
  <p>Each <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">full node</a> in the Umkoin <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> independently stores a <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>
containing only <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> validated by that <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>. When several <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> all
...
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> follow to maintain <a href="/en/glossary/consensus" title="When several nodes (usually most nodes on the network) all have the same blocks in their locally-validated best block chain." class="auto-link">consensus</a> are called <a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." id="term-consensus-rules" class="term">consensus
rules</a>. This section describes many of
the <a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">consensus rules</a> used by Umkoin Core.</p>
...
<a href="/en/glossary/merkle-root" title="The root node of a merkle tree, a descendant of all the hashed pairs in the tree.  Block headers must include a valid merkle root descended from all transactions in that block." id="term-merkle-root" class="term">merkle root</a> of a <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Umkoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a>.</p>
...
modifying the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> that records it and all following <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>.</p>
  ...
  <p>Transactions are also chained together. Umkoin <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> software gives
...
<a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">bitcoins</a> really move from transaction to transaction. Each
transaction spends the <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> previously received in one or more earlier
...
the case when sending to multiple <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address.  Currently the most common way users exchange payment information." class="auto-link">addresses</a>, but each <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> of
...
spend</a>—an attempt to spend the same <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> twice.</p>
...
fee</a> by the Umkoin
<a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." id="term-miner" class="term">miner</a> who creates the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> containing that
transaction.
For example, in the illustration above, each transaction spends 10,000 <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>The <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> is collaboratively maintained by anonymous <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> on the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, so
Umkoin requires that each <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> prove a significant amount of work was invested in
its creation to ensure that untrustworthy <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> who want to modify past <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> have
to work harder than honest <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> who only want to add new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> to the
...
added to the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>, magnifying the effect of the <a href="/en/glossary/proof-of-work" title="A hash below a target value which can only be obtained, on average, by performing a certain amount of brute force work---therefore demonstrating proof of work." class="auto-link">proof of work</a>.</p>
  ...
  <p>The <a href="/en/glossary/proof-of-work" title="A hash below a target value which can only be obtained, on average, by performing a certain amount of brute force work---therefore demonstrating proof of work." id="term-proof-of-work" class="term">proof of work</a> used in Umkoin
...
threshold.
Umkoin assumes a linear probability that the lower it makes the <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target threshold</a>, the more hash attempts (on average) will need to be tried.</p>
...
the same reason.</p>
  ...
  <p>(Note: an off-by-one error in the Umkoin Core implementation causes the
...
Only if you acquired a majority of the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network’s</a> hashing power
...
the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Umkoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a>.</p>
...
illustration above.</p>
  ...
  <p>When <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> produce simultaneous <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> at the end of the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>, each
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> individually chooses which <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> to accept. In the absence of
other considerations, discussed below, <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> usually use the first
...
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>, normal <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> always follow the most difficult chain
...
<a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> almost always do include additional transactions in order to
...
identifier</a> (<a href="/en/glossary/txid" title="An identifier used to uniquely identify a particular transaction; specifically, the sha256d hash of the transaction." class="auto-link">txid</a>). From these <a href="/en/glossary/txid" title="An identifier used to uniquely identify a particular transaction; specifically, the sha256d hash of the transaction." class="auto-link">txids</a>, the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Umkoin, the leaves are almost always transactions from a single block." id="term-merkle-tree" class="term">merkle tree</a> is constructed by pairing each
...
five-transaction <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Umkoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a> would look like the following text diagram:</p>
...
A  B  C  D  E .........Transactions
  ...
  <p>As discussed in the <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">Simplified Payment Verification</a> (<a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV</a>) subsection,
the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Umkoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a> allows clients to verify for
...
from a full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a>. The full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> does not need to be trusted: it is
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>To maintain <a href="/en/glossary/consensus" title="When several nodes (usually most nodes on the network) all have the same blocks in their locally-validated best block chain." class="auto-link">consensus</a>, all full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> validate <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> using the same
...
introduce new features or prevent <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> abuse. When the new rules are
implemented, there will likely be a period of time when non-upgraded
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> follow the old rules and upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> follow the new rules,
...
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> but rejected by non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>. For example, a new
transaction feature is used within a <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>: upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> understand
the feature and accept it, but non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> reject it because
...
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> but accepted by non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>. For example, an abusive
transaction feature is used within a <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>: upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> reject it
because it violates the new rules, but non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> accept it
because it follows the old rules.</p>
    </li>
  </ol>

  <p>In the first case, rejection by non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>, <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software
which gets <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> data from those non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> refuses to
build on the same chain as <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software getting data from upgraded
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>. This creates permanently divergent chains—one for non-upgraded
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> and one for upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>—called a <a href="/en/glossary/hard-fork" title="A permanent divergence in the block chain, commonly occurs when non-upgraded nodes can't validate blocks created by upgraded nodes that follow newer consensus rules." id="term-hard-fork" class="term">hard
fork</a>.</p>

  <p><img src="/img/dev/en-hard-fork.svg" alt="Hard Fork" /></p>

  <p>In the second case, rejection by upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>, it’s possible to keep
the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> from permanently diverging if upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> control a
majority of the hash rate. That’s because, in this case, non-upgraded
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> will accept as valid all the same <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> as upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>, so the
upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> can build a stronger chain that the non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>
...
not required—but it is a possible outcome.</p>
  ...
  <p><a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">Consensus rule</a> changes may be activated in various ways. During Umkoin’s 
...
they are dependent on having sufficient users (<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>) to enforce the new rules
...
threshold has been passed, all <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> will begin enforcing the new rules. Such
...
as they are dependent on <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> for activation.</p>
...
of upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>, and an intentional <a href="/en/glossary/hard-fork" title="A permanent divergence in the block chain, commonly occurs when non-upgraded nodes can't validate blocks created by upgraded nodes that follow newer consensus rules." class="auto-link">hard fork</a> when the temporary
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> may use and distribute incorrect information during
...
financial loss. In particular, non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> may relay and accept
transactions that are considered invalid by upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> and so will
...
Non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> may also refuse to relay <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> or transactions which
...
provide incomplete information.</p>
  ...
  <p>Umkoin Core includes code that detects a <a href="/en/glossary/hard-fork" title="A permanent divergence in the block chain, commonly occurs when non-upgraded nodes can't validate blocks created by upgraded nodes that follow newer consensus rules." class="auto-link">hard fork</a> by looking at <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block
chain</a> <a href="/en/glossary/proof-of-work" title="A hash below a target value which can only be obtained, on average, by performing a certain amount of brute force work---therefore demonstrating proof of work." class="auto-link">proof of work</a>. If a non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> receives <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a>
...
it considers valid, the <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> reports a warning in the <a href="/en/developer-reference#getnetworkinfo" class="auto-link"><code>getnetworkinfo</code> RPC</a>
results and runs the <code>-alertnotify</code> command if set.  This warns the
operator that the non-upgraded <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> can’t switch to what is likely the
<a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a>.</p>
  ...
  <p>Full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> can also check <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> and transaction version numbers. If the
...
higher than the version numbers the <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> uses, it can assume it doesn’t
use the current <a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">consensus rules</a>. Umkoin Core reports this situation 
...
if it comes from a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> that apparently isn’t using the current 
<a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">consensus rules</a>.</p>
  ...
  <p><a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV clients</a> which connect to full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> can detect a likely <a href="/en/glossary/hard-fork" title="A permanent divergence in the block chain, commonly occurs when non-upgraded nodes can't validate blocks created by upgraded nodes that follow newer consensus rules." class="auto-link">hard fork</a> by
connecting to several full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> and ensuring that they’re all on the
...
divergence, the client can disconnect from <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> with weaker chains.</p>

  <p><a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV clients</a> should also monitor for <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> and <a href="/en/developer-guide#term-transaction-version-number" title="A version number prefixed to transactions to allow upgrading&quot;" class="auto-link">transaction version number</a>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Transactions let users spend <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>. Each transaction is constructed
...
not exist. <a href="/en/glossary/coinbase-transaction" title="The first transaction in a block.  Always created by a miner, it includes a single coinbase." class="auto-link">Coinbase transactions</a> can only be created by Umkoin <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a>
...
Umkoin <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> and <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> which set of rules to use to validate it.  This
...
amount of <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> paid to it.</p>
...
The <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> categorizes it as an Unspent Transaction <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">Output</a> (<a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a>), and Bob’s
...
broadcast them over the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>.</p>
...
broadcasts the transaction to Umkoin <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> through the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer
network</a>. Each <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> and <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> independently validates the transaction
...
<a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a> ensures the full <a href="/en/glossary/redeem-script" title="A script similar in function to a pubkey script. One copy of it is hashed to create a P2SH address (used in an actual pubkey script) and another copy is placed in the spending signature script to enforce its conditions." class="auto-link">redeem script hashes</a> to the same
...
<a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> if their <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey scripts</a> and <a href="/en/glossary/signature-script" title="Data generated by a spender which is almost always used as variables to satisfy a pubkey script. Signature Scripts are called scriptSig in code." class="auto-link">signature scripts</a> matched a small set of
believed-to-be-safe templates, and if the rest of the transaction didn’t
violate another small set of rules enforcing good <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> behavior. This
...
by <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> not using the default Umkoin Core settings. If they are
...
rules</a>, such as not having any data pushes larger than 520 bytes.</p>
  ...
  <p>Umkoin Core 0.9.x to 0.10.x will, by default, relay and <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mine</a> <a href="/en/glossary/null-data-transaction" title="A transaction type relayed and mined by default in Umkoin Core 0.9.0 and later that adds arbitrary data to a provably unspendable pubkey script that full nodes don't have to store in their UTXO database." class="auto-link">null data
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>If you use anything besides a standard <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey script</a> in an <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>, <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a>
and <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> using the default Umkoin Core settings will neither
accept, broadcast, nor <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mine</a> your transaction. When you try to broadcast
your transaction to a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> running the default settings, you will
receive an error.</p>
...
scripts that use unassigned <a href="https://en.bitcoin.it/wiki/Script#Reserved_words">NOP opcodes</a>; these <a href="/en/glossary/op-code" title="Operation codes from the Umkoin Script language which push data or perform functions within a pubkey script or signature script." class="auto-link">opcodes</a> are
reserved for future <a href="/en/glossary/soft-fork" title="A softfork is a change to the bitcoin protocol  wherein only previously valid blocks/transactions  are made invalid. Since old nodes will recognise  the new blocks as valid, a softfork is backward-compatible." class="auto-link">soft forks</a> and can only be relayed or mined by <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>
...
<a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, not prevent you from making mistakes. It’s easy to create
...
allowing anyone to change where the <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> are going unless other
...
change how many <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> are sent nor where they go.</p>
    </li>
    <li>
...
the <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> without consulting the <code>NONE</code> signer—but nobody else can
...
the time lock expires.</p>
  ...
  <p>Care must be taken near the expiry time of a time lock. The <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer
...
broadcast a transaction across the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>. Any transaction paying only the <a href="/en/glossary/minimum-relay-fee" title="The minimum transaction fee a transaction must pay (if it isn't a high-priority transaction) for a full node to relay that transaction to other nodes. There is no one minimum relay fee---each node chooses its own policy." class="auto-link">minimum fee</a>
...
spend their <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
...
attack by only generating one <a href="/en/glossary/signature" title="A value related to a public key which could only have reasonably been created by someone who has the private key that created that public key. Used in Umkoin to authorize spending satoshis previously sent to a public key." class="auto-link">signature</a> per <a href="/en/glossary/private-key" title="The private portion of a keypair which can create signatures that other people can verify using the public key." class="auto-link">private key</a>, so attackers
...
especially if large amounts of <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> are at stake.</p>
...
the transaction has disappeared from the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>.</p>
...
disappear from the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> and needs to be reissued, that it be reissued
...
help ensure Charlie gets his merchandise and Bob gets his payment.</p>
  ...
  <p>A simple contract could say that Charlie will spend <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to an
...
contract</a>. Charlie spends his <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
...
who should get the <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> if there’s a dispute.</p>
...
<a href="/en/developer-reference#term-op-checkmultisig" title="Opcode which returns true if one or more provided signatures (m) sign the correct parts of a transaction and match one or more provided public keys (n)"><code>OP_CHECKMULTISIG</code></a> for details.)</p>
  ...
  <p>When the transaction is broadcast to the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, each <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> checks the
...
agree to, such as spending all the <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to herself, Bob and Charlie
can find a new arbitrator and sign a transaction spending the <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
...
The first transaction pays 100 <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a> to a <a href="/en/glossary/p2sh-address" title="A Umkoin payment address comprising a hashed script, allowing the spender to create a standard pubkey script that Pays To Script Hash (P2SH). The script can be almost any valid pubkey script." class="auto-link">P2SH output</a> whose
...
Broadcasting this transaction would let Alice hold the <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a>
hostage, so Bob keeps this transaction private for now and creates a
second transaction.</p>

  <p>The second transaction spends all of the first transaction’s <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a>
...
transaction to the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> to ensure Bob has to wait for the time lock
to expire before further spending his <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a>. Bob hasn’t actually
...
full <a href="/en/developer-guide#issuing-refunds" title="A transaction which refunds some or all satoshis received in a previous transaction" class="auto-link">refund</a>.</p>
  ...
  <p>Now, when Alice does some work worth 1 <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoin</a>, she asks Bob to create
...
transaction spends 1 <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoin</a> to Alice and the other 99 back to Bob; it does
...
two transactions, Alice could hold Bob’s 100 <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a> hostage even if she
hadn’t done any work.</p>

  <p>For larger payments, Umkoin <a href="/en/glossary/transaction-fee" title="The amount remaining when the value of all outputs in a transaction are subtracted from all inputs in a transaction; the fee is paid to the miner who includes that transaction in a block." class="auto-link">transaction fees</a> are very low as a
...
can each easily track those <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to learn what Umkoin
...
<a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> she has left.</p>

  <p>Alice isn’t a criminal, she just wants plausible deniability about
where she has spent her <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and how many she has left, so she
...
agree to transfer <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> between each other so no one besides them
can reliably determine who controls which <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.  But they’re faced
with a dilemma: who transfers their <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to one of the other two
...
of them can steal the others’ <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
...
a brand new <a href="/en/glossary/public-key" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a> and give <a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a> details and <a href="/en/glossary/p2pkh-address" title="A Umkoin payment address comprising a hashed public key, allowing the spender to create a standard pubkey script that Pays To PubKey Hash (P2PKH)." class="auto-link">pubkey hashes</a> to the
...
the transaction to the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>, mixing all of the <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoins</a> in
...
CoinJoined with to find out the ultimate origin of her <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and
...
technique, purchaser CoinJoin, can actually save them <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and
improve their privacy at the same time.</p>

  <p>AnonGirl waits in the IRC chatroom until she wants to make a purchase.
She announces her intention to spend <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and waits until someone
...
saving each one of them a tiny amount of <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Permitting receiving and spending of <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> is the only essential
...
another program signing transactions spending those <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>

  <p><a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">Wallet</a> programs also need to interact with the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a> to
...
don’t need to interact with the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a> themselves.</p>
...
<a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
...
interacts with the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>.</p>
...
<a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>.</p>
...
device which does not connect to any <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, greatly reducing the
...
broadcast it to the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>.</p>
    </li>
  </ol>
...
transactions before signing, the user’s <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> are safe even if the
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Because of exchange rate variability between <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> and national
currencies (<a href="/en/developer-guide#term-fiat" title="National currencies such as the dollar or euro" id="term-fiat" class="term">fiat</a>), many Umkoin orders are priced in <a href="/en/developer-guide#term-fiat" title="National currencies such as the dollar or euro" class="auto-link">fiat</a> but paid
in <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, necessitating a price conversion.</p>
...
current general market value of <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, or the applications could
accept too few <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> for the product or service being sold.
Alternatively, they could ask for too many <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, driving away potential
spenders.</p>
...
spend any <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> received today.</p>
...
that <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> will drop in price. Most widely-used payment processing
...
request</a> and the <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> used in it, and then scan the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> for
...
the <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>, the amount, and the <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">denomination</a>. An expiration time for
...
You must pay by: 2014-04-01 at 23:00 UTC
  ...
  <p>Indicating the <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">denomination</a> is critical. As of this writing, popular
...
but other software also lets its users select <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">denomination</a> amounts from
some or all of the following options:</p>

  <table>
    <thead>
      <tr>
        <th><a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">Umkoins</a></th>
    ...
    <tbody>
      ...
      <tr>
        <td>0.001</td>
        <td><a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">millibitcoin</a> (mBTC)</td>
      </tr>
      <tr>
        <td>0.000001</td>
        <td><a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">microbitcoin</a> (uBTC, “bits”)</td>
      </tr>
      <tr>
        <td>0.00000001</td>
        <td><a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshi</a></td>
      </tr>
    </tbody>
  </table>
...
decimal <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">bitcoins</a> (BTC).</p>
...
different <a href="/en/developer-guide#term-uri-qr-code" title="A QR code containing a bitcoin: URI" id="term-uri-qr-code" class="term">Umkoin QR codes</a> at four
...
or low-resolution mobile cameras.</p>
  ...
  <p>The error correction is combined with a checksum to ensure the <a href="/en/developer-guide#term-uri-qr-code" title="A QR code containing a bitcoin: URI" class="auto-link">Umkoin QR code</a>
...
through the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>. This can speed up payment processing and
...
shipping <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a>.</p>
    ...
    <li>
      <p>An order total in <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, perhaps created by converting prices in
...
return some or all of Charlie’s <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
    </li>
  </ul>
...
transaction to the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>. It also replies to the HTTP POSTed Payment
...
number of <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> for goods specified in the memo field.</p>
    </li>
    <li>
      <p>The Umkoin <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> can prove that the <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey script</a> specified by
Bob was paid the specified number of <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>.</p>
    </li>
  </ul>
...
a transaction to the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> doesn’t ensure that the receiver gets
...
trusted without risk analysis. Although <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> usually confirm the first 
transaction they receive, fraudsters may be able to manipulate the
<a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> into including their version of a transaction.</p>
...
expensive <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> equipment.</p>

  <p><strong>6 <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">confirmations</a></strong>: The <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> has spent about an hour working to protect 
...
connecting to large numbers of Umkoin <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> to track how transactions and 
...
estimate the amount of time until they’re added to a <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>.</p>
  ...
  <p>Another example could be to detect a <a href="/en/glossary/fork" title="When two or more blocks have the same block height, forking the block chain.  Typically occurs when two or more miners find blocks at nearly the same time.  Can also happen as part of an attack." class="auto-link">fork</a> when multiple <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> report differing 
...
the Umkoin <a href="/en/glossary/address" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address.  Currently the most common way users exchange payment information." class="auto-link">address</a> mjSk1Ny9spzU2fouzYgLqGUD8U41iR35QN.</p>
    ...
    <li>
      <p>Bob discovers Alice paid too many <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>. Being an honest fellow,
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Many receivers worry that their <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> will be less valuable in the
...
earned, spent, and saved.</p>
    ...
    <li>
      <p>A last-in-first-out (LIFO) algorithm spends newly acquired <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
...
possibly bad for their reputation.</p>
    ...
    <li>
      <p>A first-in-first-out (FIFO) algorithm spends the oldest <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>
...
(in a crude way) how the receiver spends those <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>. But the spender
can’t automatically see other <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> paid to the receiver by other
...
transaction.</p>
  ...
  <p>However, if the receiver spends <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> from two different spenders in
...
diminishing returns is reached. The <a href="https://umkoin.org/en/bitcoin-paper">original Umkoin paper</a>
...
assuming the attacker has 30% of the total <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> hashing power:</p>
...
aside for no-fee-required <a href="/en/glossary/high-priority-transaction" title="Transactions that don't have to pay a transaction fee because their inputs have been idle long enough to accumulated large amounts of priority.  Note: miners choose whether to accept free transactions." class="auto-link">high-priority transactions</a> by <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> running the default Umkoin Core
...
centralized server which handles <a href="/en/glossary/denominations" title="Denominations of Umkoin value, usually measured in fractions of a bitcoin but sometimes measured in multiples of a satoshi.  One bitcoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> on behalf of its spenders. In
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Currently there are two primary methods of validating the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> as a client: Full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> and <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV clients</a>. Other methods, such as server-trusting methods, are not discussed as they are not recommended.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>The <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block’s</a> depth in the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> corresponds to the cumulative <a href="/en/glossary/difficulty" title="How difficult it is to find a block relative to the difficulty of finding the easiest possible block. The easiest possible block has a proof-of-work difficulty of 1." class="auto-link">difficulty</a> that has been performed to build on top of that particular <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. The <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV client</a> knows the <a href="/en/glossary/merkle-root" title="The root node of a merkle tree, a descendant of all the hashed pairs in the tree.  Block headers must include a valid merkle root descended from all transactions in that block." class="auto-link">merkle root</a> and associated transaction information, and requests the respective merkle branch from a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">full node</a>. Once the merkle branch has been retrieved, proving the existence of the transaction in the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>, the <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV client</a> can then look to <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> <em>depth</em> as a proxy for transaction validity and security. The cost of an attack on a user by a malicious <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> who inserts an invalid transaction grows with the cumulative <a href="/en/glossary/difficulty" title="How difficult it is to find a block relative to the difficulty of finding the easiest possible block. The easiest possible block has a proof-of-work difficulty of 1." class="auto-link">difficulty</a> built on top of that <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>, since the malicious <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> alone will be <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> this forged chain.</p>
...
scripts</a> and <a href="/en/glossary/pubkey-script" title="A script included in outputs which sets the conditions that must be fulfilled for those satoshis to be spent.  Data for fulfilling the conditions can be provided in a signature script. Pubkey Scripts are called a scriptPubKey in code." class="auto-link">pubkey scripts</a>, and more. This enables P2SH transaction finding.</p>
  ...
  <p>If a user is more privacy-conscious, he can set the <a href="/en/glossary/bloom-filter" title="A filter used primarily by SPV clients to request only matching transactions and merkle blocks from full nodes." class="auto-link">Bloom filter</a> to include more false positives, at the expense of extra bandwidth used for transaction discovery. If a user is on a tight bandwidth budget, he can set the false-positive rate to low, knowing that this will allow full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> a clear view of what transactions are associated with his client.</p>

  <p><strong>Resources:</strong> <a href="http://bitcoinj.github.io">UmkoinJ</a>, a Java implementation of Umkoin that is based on the <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV</a> security model and <a href="/en/glossary/bloom-filter" title="A filter used primarily by SPV clients to request only matching transactions and merkle blocks from full nodes." class="auto-link">Bloom filters</a>. Used in most Android <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallets</a>.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>There are future proposals such as Unspent Transaction <a href="/en/glossary/output" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">Output</a> (<a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a>) commitments in the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> to find a more satisfactory middle-ground for clients between needing a complete copy of the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>, or trusting that a majority of your connected <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> are not lying. <a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a> commitments would enable a very secure client using a finite amount of storage using a data structure that is authenticated in the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>. These type of proposals are, however, in very early stages, and will require <a href="/en/glossary/soft-fork" title="A softfork is a change to the bitcoin protocol  wherein only previously valid blocks/transactions  are made invalid. Since old nodes will recognise  the new blocks as valid, a softfork is backward-compatible." class="auto-link">soft forks</a> in the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>The Umkoin <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> protocol allows full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>
(<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a>) to collaboratively maintain a
<a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" id="term-network" class="term">peer-to-peer network</a> for <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> and
transaction exchange. Full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> download and verify every <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> and transaction
prior to relaying them to other <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>. Archival <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> are full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> which
store the entire <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">blockchain</a> and can serve historical <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> to other <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>.
Pruned <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> are full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> which do not store the entire <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">blockchain</a>. Many <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV 
clients</a> also use the Umkoin <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> protocol to connect to full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>.</p>

  <p><a href="/en/glossary/consensus-rules" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">Consensus rules</a> do not cover networking, so Umkoin programs may use
...
network</a> used by some <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> and the <a href="https://github.com/spesmilo/electrum-server">dedicated transaction
...
<a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV</a>-level security.</p>
  ...
  <p>To provide practical examples of the Umkoin <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>, this
section uses Umkoin Core as a representative <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">full node</a> and <a href="http://bitcoinj.github.io">UmkoinJ</a>
...
addresses of any active full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>. In order to discover some IP
...
<a href="http://bitcoinj.github.io" class="auto-link">UmkoinJ</a>. The response to the lookup should include one or more <a href="http://tools.ietf.org/html/rfc1035#section-3.2.2">DNS
A records</a> with the IP addresses of full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> that may accept new
...
of active <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> by scanning the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>; others provide static <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Umkoin network to assist in peer discovery." class="auto-link">DNS
seeds</a> that are updated manually and are more likely to provide IP
addresses for inactive <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>. In either case, <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> are added to the
<a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Umkoin network to assist in peer discovery." class="auto-link">DNS seed</a> if they run on the default Umkoin ports of 8333 for <a href="/en/glossary/mainnet" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a>
or 18333 for <a href="/en/glossary/testnet" title="A global testing environment in which developers can obtain and spend satoshis that have no real-world value on a network that is very similar to the Umkoin mainnet." class="auto-link">testnet</a>.</p>
...
<a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> <a href="https://en.wikipedia.org/wiki/Man-in-the-middle_attack" class="auto-link">man-in-the-middle</a> attacker can return only IP addresses of
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> controlled by the attacker, isolating a program on the attacker’s
own <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> and allowing the attacker to feed it bogus transactions and
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>.  For this reason, programs should not rely on <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Umkoin network to assist in peer discovery." class="auto-link">DNS seeds</a>
exclusively.</p>

  <p>Once a program has connected to the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, its <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> can begin to send
it <code>addr</code>
(address) messages with the IP addresses and port numbers of
other <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> on the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, providing a fully decentralized method of
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> discovery. Umkoin Core keeps a record of known <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> in a
persistent on-disk database which usually allows it to connect directly
to those <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> on subsequent startups without having to use <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Umkoin network to assist in peer discovery." class="auto-link">DNS seeds</a>.</p>

  <p>However, <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> often leave the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> or change IP addresses, so
...
<a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>, forcing a user to wait before sending a transaction or checking
the status of payment.</p>

  <p>To avoid this possible delay, <a href="http://bitcoinj.github.io" class="auto-link">UmkoinJ</a> always uses dynamic <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Umkoin network to assist in peer discovery." class="auto-link">DNS seeds</a> to
get IP addresses for <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> believed to be currently active.
...
its <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> database, it spends up to 11 seconds attempting to connect to
at least one of them before falling back to seeds; if a connection is
made within that time, it does not query any seeds.</p>

  <p>Both Umkoin Core and <a href="http://bitcoinj.github.io" class="auto-link">UmkoinJ</a> also include a hardcoded list of IP
addresses and port numbers to several dozen <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> which were active
around the time that particular version of the software was first
released. Umkoin Core will start attempting to connect to these <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>
if none of the <a href="/en/glossary/dns-seed" title="A DNS server which returns IP addresses of full nodes on the Umkoin network to assist in peer discovery." class="auto-link">DNS seed</a> servers have responded to a query within 60
...
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> from a specific <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> by IP address, or to make a persistent
connection to a specific <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> by IP address.  See the <code>-help</code> text for
details.  <a href="http://bitcoinj.github.io" class="auto-link">UmkoinJ</a> can be programmed to do the same thing.</p>

  <p><strong>Resources:</strong> <a href="https://github.com/sipa/bitcoin-seeder">Umkoin Seeder</a>, the program run by several of the
seeds used by Umkoin Core and <a href="http://bitcoinj.github.io" class="auto-link">UmkoinJ</a>. The Umkoin Core <a href="https://github.com/bitcoin/bitcoin/blob/master/doc/dnsseed-policy.md">DNS Seed
Policy</a>.  The hardcoded list of IP addresses used by Umkoin Core and
<a href="http://bitcoinj.github.io" class="auto-link">UmkoinJ</a> is generated using the <a href="https://github.com/bitcoin/bitcoin/tree/master/contrib/seeds">makeseeds script</a>.</p>
...
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>. The remote <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> responds with its own <a href="/en/developer-reference#version" title="A P2P network message sent at the begining of a connection to allow protocol version negotiation" class="auto-link"><code>version</code> message</a>. Then both
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> send a <a href="/en/developer-reference#verack" title="A P2P network message sent in reply to a version message to confirm a connection has been established" class="auto-link"><code>verack</code> message</a> to the other <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> to indicate the
connection has been established.</p>

  <p>Once connected, the client can send to the remote <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> <code>getaddr</code> and <a href="/en/developer-reference#addr" title="The P2P network message which relays IP addresses and port numbers of active nodes to other nodes and clients, allowing decentralized peer discovery." class="auto-link"><code>addr</code> messages</a> to gather additional <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a>.</p>

  <p>In order to maintain a connection with a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a>, <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> by default will send a message to <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> before 30 minutes of inactivity. If 90 minutes pass without a message being received by a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a>, the client will assume that connection has closed.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Before a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">full node</a> can validate <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transactions</a> and
...
downloaded, such as when a previously-caught-up <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> has been offline
for a long time. In this case, a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> can use the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> method to download
...
<a href="/en/release/v0.10.0" class="auto-link">Umkoin Core 0.10.0</a> will also perform <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> if its local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a> is
...
The goal is to download the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> from the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a> in sequence.</p>
  ...
  <p>The first time a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> is started, it only has a single <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> in its
local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a>—the hardcoded <a href="/en/glossary/genesis-block" title="The first block in the Umkoin block chain." class="auto-link">genesis block</a> (<a href="/en/glossary/genesis-block" title="The first block in the Umkoin block chain." class="auto-link">block 0</a>).  This
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> chooses a remote <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a>, called the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>, and sends it the
<a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a> illustrated below.</p>
  ...
  <p>In the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hashes field of the <a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a>, this new <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>
...
to all zeroes to request a maximum-size response.</p>
  ...
  <p>Upon <a href="/en/developer-guide#term-receipt" title="A cryptographically-verifiable receipt created using parts of a payment request and a confirmed transaction" class="auto-link">receipt</a> of the <a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a>, the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> takes the first
...
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> with that <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hash. It finds that <a href="/en/glossary/genesis-block" title="The first block in the Umkoin block chain." class="auto-link">block 0</a> matches, so it
...
the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block’s</a> <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a>.</p>
  ...
  <p>The <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventories</a> appear in the <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a> in the same order they
...
<a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventories</a> for <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> 1 through 501. (For example, the hash of <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> 1
is 4860…0000 as seen in the illustration above.)</p>

  <p>The <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> uses the received <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventories</a> to request 128 <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> from
the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> in the <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> message</a> illustrated below.</p>

  <p><img src="/img/dev/en-ibd-getdata.svg" alt="First GetData Message Sent During IBD" /></p>

  <p>It’s important to <a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">blocks-first</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> that the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> be requested and
...
the preceding <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. That means the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> can’t fully validate a
...
blocks</a>; a subsection below describes them in more detail.</p>
  ...
  <p>Upon <a href="/en/developer-guide#term-receipt" title="A cryptographically-verifiable receipt created using parts of a payment request and a confirmed transaction" class="auto-link">receipt</a> of the <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> message</a>, the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> replies with each
...
(for <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> 1) is illustrated below.</p>
  ...
  <p>The <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> downloads each <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>, validates it, and then requests the
...
an <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventory</a>, it sends another <a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a> to the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>
requesting the <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventories</a> of up to 500 more <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>.  This second
...
below:</p>
  ...
  <p>Upon <a href="/en/developer-guide#term-receipt" title="A cryptographically-verifiable receipt created using parts of a payment request and a confirmed transaction" class="auto-link">receipt</a> of the second <a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a>, the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> searches
...
two <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> have in common is <a href="/en/glossary/genesis-block" title="The first block in the Umkoin block chain." class="auto-link">block 0</a> and so it sends an <code>inv</code> starting with
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> 1 (the same <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a> seen several illustrations above).</p>
  ...
  <p>This repeated search allows the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> to send useful <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventories</a> even if
the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node’s</a> local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> forked from the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node’s</a> local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block
...
<a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> gets to the tip of the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>.</p>

  <p>When the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> receives the second <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a>, it will request
those <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> using <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> messages</a>.  The sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will respond with
<a href="/en/developer-reference#block" title="The P2P network message which sends a serialized block" class="auto-link"><code>block</code> messages</a>.  Then the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will request more <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventories</a> with
...
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> is synced to the tip of the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>.  At that point, the <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>
...
disadvantage is that the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> relies on a single sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> for all
of its downloading. This has several implications:</p>

  <ul>
    <li>
      <p><strong>Speed Limits:</strong> All requests are made to the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>, so if the
sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> has limited upload bandwidth, the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will have slow
download speeds.  Note: if the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> goes offline, Umkoin Core
will continue downloading from another <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>—but it will still only
download from a single sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> at a time.</p>
    </li>
    <li>
      <p><strong>Download Restarts:</strong> The sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> can send a non-best (but
otherwise valid) <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> to the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>. The <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> won’t be
...
completion, forcing the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> to restart its <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> download
over again from a different <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>. Umkoin Core ships with several
...
developers to help an <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> detect that it is being fed an
alternative <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> history—allowing the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> to restart
its download earlier in the process.</p>
    </li>
    <li>
      <p><strong>Disk Fill Attacks:</strong> Closely related to the download restarts, if
the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> sends a non-best (but otherwise valid) <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>, the
chain will be stored on disk, wasting space and possibly filling up
the disk drive with useless data.</p>
    </li>
    <li>
      <p><strong>High Memory Use:</strong> Whether maliciously or by accident, the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>
...
solves several problems with the older <a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">blocks-first IBD</a> method.</p>
  ...
  <p>The first time a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> is started, it only has a single <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> in its
local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a>—the hardcoded <a href="/en/glossary/genesis-block" title="The first block in the Umkoin block chain." class="auto-link">genesis block</a> (<a href="/en/glossary/genesis-block" title="The first block in the Umkoin block chain." class="auto-link">block 0</a>).  The
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> chooses a remote <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a>, which we’ll call the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>, and sends it the
<a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code> message</a> illustrated below.</p>
  ...
  <p>In the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hashes field of the <a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code> message</a>, the new <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>
sends the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hash of the only <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> it has, the <a href="/en/glossary/genesis-block" title="The first block in the Umkoin block chain." class="auto-link">genesis block</a>
(6fe2…0000 in <a href="/en/glossary/internal-byte-order" title="The standard order in which hash digests are displayed as strings---the same format used in serialized blocks and transactions." class="auto-link">internal byte order</a>).  It also sets the stop hash field
to all zeroes to request a maximum-size response.</p>

  <p>Upon <a href="/en/developer-guide#term-receipt" title="A cryptographically-verifiable receipt created using parts of a payment request and a confirmed transaction" class="auto-link">receipt</a> of the <a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code> message</a>, the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> takes the first
(and only) <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hash and searches its local <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a> for a
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> with that <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hash. It finds that <a href="/en/glossary/genesis-block" title="The first block in the Umkoin block chain." class="auto-link">block 0</a> matches, so it
...
illustrated below.</p>
  ...
  <p>The <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> can partially validate these <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block headers</a> by ensuring that
...
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>.)</p>
  ...
  <p>After the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> has partially validated the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block headers</a>, it can do
two things in parallel:</p>

  <ol>
    <li>
      <p><strong>Download More <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">Headers</a>:</strong> the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> can send another <a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code>
message</a> to the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> to request the next 2,000 <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> on the
...
of downloaded data.</p>
      ...
      <p>Once the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> receives a <a href="/en/developer-reference#headers" title="A P2P protocol message containing one or more block headers" class="auto-link"><code>headers</code> message</a> with fewer than 2,000
 <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> from the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>, it sends a <a href="/en/developer-reference#getheaders" title="A P2P protocol message used to request a range of block headers" class="auto-link"><code>getheaders</code> message</a> to each
 of its outbound <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> to get their view of <a href="/en/glossary/header-chain" title="A chain of block headers with each header linking to the header that preceded it; the most-difficult-to-recreate chain is the best header chain" class="auto-link">best header chain</a>. By
 ...
 its outbound <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a>. This means a dishonest sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will quickly be
 discovered even if checkpoints aren’t used (as long as the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>
 connects to at least one honest <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a>; Umkoin Core will continue to
 provide checkpoints in case honest <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> can’t be found).</p>
    </li>
    <li>
      <p><strong>Download <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">Blocks</a>:</strong> While the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> continues downloading
<a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a>, and after the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> finish downloading, the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will
request and download each <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. The <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> can use the <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block
...
doesn’t need to request these from the sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>—it can request
them from any of its <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">full node</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a>. (Although not all full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a>
...
single sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>.</p>

      <p>To spread the load between multiple <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a>, Umkoin Core will only
 request up to 16 <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> at a time from a single <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a>. Combined with
 ...
 Umkoin Core will request a maximum of 128 <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> simultaneously
 ...
 requested from its sync <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>).</p>
    </li>
  </ol>
...
minimum of two more seconds for the stalling <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> to send the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. If
the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> still hasn’t arrived, Umkoin Core will disconnect from the
stalling <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> and attempt to connect to another <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>. For example, in
the illustration above, <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">Node</a> A will be disconnected if it doesn’t send
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> 3 within at least two seconds.</p>
  ...
  <p>Once the <a href="/en/glossary/initial-block-download" title="The process used by a new node (or long-offline node) to download a large number of blocks to catch up to the tip of the best block chain." class="auto-link">IBD</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> is synced to the tip of the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>, it will
  ...
  <table>
    <tbody>
      ...
      <tr>
        ...
        <td>One or more <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventories</a> derived from <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hashes</td>
        <td>One <a href="/en/glossary/serialized-block" title="A complete block in its binary format---the same format used to calculate total block byte size; often represented using hexadecimal." class="auto-link">serialized block</a></td>
      </tr>
    </tbody>
  </table>
...
the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> sends a <a href="/en/developer-reference#block" title="The P2P network message which sends a serialized block" class="auto-link"><code>block</code> message</a> to each of its <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">full node</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> with
the new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. The <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> can reasonably bypass the standard relay
method in this way because it knows none of its <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> already have the
...
to the new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. The most common responses are:</p>
      ...
      <ul>
        <li>
          <p>Each <a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">blocks-first</a> (BF) <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> that wants the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> replies with a
<a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> message</a> requesting the full <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>.</p>
        ...
        <li>
          <p>Each <a href="/en/glossary/headers-first-sync" title="Synchronizing the block chain by downloading block headers before downloading the full blocks." class="auto-link">headers-first</a> (HF) <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> that wants the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> replies with a
...
a relay <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> may skip the round trip overhead of an <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a>
...
will accept <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> sent using any of the methods described above.</p>
  ...
  <p>Full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> validate the received <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> and then advertise it to their
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> using the <a href="/en/developer-guide#term-standard-block-relay" title="The regular block relay method: announcing a block with an inv message and waiting for a response" class="auto-link">standard block relay</a> method described above.  The condensed
table below highlights the operation of the messages described above
(Relay, BF, HF, and <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV</a> refer to the relay <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>, a <a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">blocks-first</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>, a
<a href="/en/glossary/headers-first-sync" title="Synchronizing the block chain by downloading block headers before downloading the full blocks." class="auto-link">headers-first</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>, and an <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV client</a>; <em>any</em> refers to a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> using any
<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> retrieval method.)</p>
  ...
  <table>
    <tbody>
      ...
      <tr>
        <td><strong>Payload</strong></td>
        <td>The <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventory</a> of the new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a></td>
        <td>The <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventory</a> of the new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a></td>
        <td>One or more <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> hashes on the HF <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node’s</a> <a href="/en/glossary/header-chain" title="A chain of block headers with each header linking to the header that preceded it; the most-difficult-to-recreate chain is the best header chain" class="auto-link">best header chain</a> (BHC)</td>
        <td>Up to 2,000 <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> connecting HF <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node’s</a> BHC to relay <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node’s</a> BHC</td>
      </tr>
      <tr>
        <td><strong>Message</strong></td>
        <td><a href="/en/developer-reference#block" title="The P2P network message which sends a serialized block"><code>block</code></a></td>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p><a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">Blocks-first</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> may download <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan blocks</a>—<a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> whose <a href="/en/developer-reference#term-previous-block-header-hash" title="A field in the block header which contains the SHA256(SHA256()) hash of the previous block's header" class="auto-link">previous
block header hash</a> field refers to a <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block header</a> this <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>
...
the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">best block chain</a>).</p>
  ...
  <p>When a <a href="/en/glossary/blocks-first-sync" title="Synchronizing the block chain by downloading each block from a peer and then validating it." class="auto-link">blocks-first</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> downloads an <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan block</a>, it will not validate
it. Instead, it will send a <a href="/en/developer-reference#getblocks" title="A P2P protocol message used to request an inv message containing a range of block header hashes" class="auto-link"><code>getblocks</code> message</a> to the <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> which sent
the <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan block</a>; the broadcasting <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will respond with an <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a>
containing <a href="/en/glossary/inventory" title="A data type identifier and a hash; used to identify transactions and blocks available for download through the Umkoin P2P network." class="auto-link">inventories</a> of any <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> the downloading <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> is missing (up
to 500); the downloading <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will request those <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> with a <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code>
message</a>; and the broadcasting <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will send those <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> with a <a href="/en/developer-reference#block" title="The P2P network message which sends a serialized block" class="auto-link"><code>block</code>
message</a>. The downloading <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will validate those <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a>, and once the
...
the former <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan block</a>.</p>
  ...
  <p><a href="/en/glossary/headers-first-sync" title="Synchronizing the block chain by downloading block headers before downloading the full blocks." class="auto-link">Headers-first</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> avoid some of this complexity by always requesting
...
with the <a href="/en/developer-reference#getdata" title="A P2P protocol message used to request one or more transactions, blocks, or merkle blocks" class="auto-link"><code>getdata</code> message</a>. The broadcasting <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will send a <a href="/en/developer-reference#headers" title="A P2P protocol message containing one or more block headers" class="auto-link"><code>headers</code>
...
downloading <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> needs to reach the tip of the <a href="/en/glossary/header-chain" title="A chain of block headers with each header linking to the header that preceded it; the most-difficult-to-recreate chain is the best header chain" class="auto-link">best header chain</a>; each of
those <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">headers</a> will point to its parent, so when the downloading <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a>
...
message</a> is an <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan block</a>, a <a href="/en/glossary/headers-first-sync" title="Synchronizing the block chain by downloading block headers before downloading the full blocks." class="auto-link">headers-first</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">node</a> will discard it immediately.</p>

  <p>However, orphan discarding does mean that <a href="/en/glossary/headers-first-sync" title="Synchronizing the block chain by downloading block headers before downloading the full blocks." class="auto-link">headers-first</a> <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> will
ignore <a href="/en/glossary/orphan-block" title="Blocks whose parent block has not been processed by the local node, so they can't be fully validated yet." class="auto-link">orphan blocks</a> sent by <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> in an <a href="/en/developer-guide#term-unsolicited-block-push" title="When a miner sends a block message without sending an inv message first" class="auto-link">unsolicited block push</a>.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>In order to send a transaction to a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a>, an <a href="/en/developer-reference#inv" title="A P2P protocol message used to send inventories of transactions and blocks known to the transmitting peer" class="auto-link"><code>inv</code> message</a> is sent. If a <code>getdata</code> response message is received, the transaction is sent using <code>tx</code>. The <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> receiving this transaction also forwards the transaction in the same manner, given that it is a valid transaction.</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Full <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> may keep track of <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transactions</a> which are eligible to
be included in the next <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>. This is essential for <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> who will
actually <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mine</a> some or all of those transactions, but it’s also useful
for any <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> who wants to keep track of <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transactions</a>, such
as <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> serving <a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transaction</a> information to <a href="/en/glossary/simplified-payment-verification" title="A method for verifying if particular transactions are included in a block without downloading the entire block.  The method is used by some lightweight Umkoin clients." class="auto-link">SPV clients</a>.</p>
...
pool or mempool. When a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> shuts down, its memory pool is lost except
...
<a href="/en/glossary/confirmation-score" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transactions</a> tend to slowly disappear from the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> as
<a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> restart or as they purge some transactions to make room in memory
for others.</p>
...
include them. This is the case in Umkoin Core, which removes <a href="/en/glossary/stale-block" title="Blocks which were successfully mined but which aren't included on the current best block chain, likely because some other block at the same height had its chain extended first." class="auto-link">stale
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Take note that for both types of broadcasting, mechanisms are in place to punish misbehaving <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peers</a> who take up bandwidth and computing resources by sending false information. If a <a href="/en/glossary/node" title="A computer that connects to the Umkoin network." class="auto-link">peer</a> gets a banscore above the <code>-banscore=&lt;n&gt;</code> threshold, he will be banned for the number of seconds defined by <code>-bantime=&lt;n&gt;</code>, which is 86,400 by default (24 hours).</p>
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p><a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">Mining</a> adds new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> to the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>, making transaction history
hard to modify.  <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">Mining</a> today takes on two forms:</p>

  <ul>
    <li>
      <p>Solo <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>, where the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> attempts to generate new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> on his
...
a higher variance (longer time between payments)</p>
    ...
    <li>
      <p>Pooled <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>, where the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> pools resources with other <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> to
...
<a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> in rough correlation to the amount of hashing power
they each contributed, allowing the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> to receive small
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>As illustrated below, solo <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> typically use <code>bitcoind</code> to get new
transactions from the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a>. Their <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software periodically polls
...
header</a> nonce and generates the corresponding hash.</p>
  ...
  <p>If none of the hashes are below the threshold, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> hardware gets
an updated <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block header</a> with a new <a href="/en/glossary/merkle-root" title="The root node of a merkle tree, a descendant of all the hashed pairs in the tree.  Block headers must include a valid merkle root descended from all transactions in that block." class="auto-link">merkle root</a> from the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software;
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>Pool <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> follow a similar workflow, illustrated below, which allows
<a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool operators to pay <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> based on their share of the work
done. The <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool gets new transactions from the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> using
<code>bitcoind</code>. Using one of the methods discussed later, each <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner’s</a> <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>
...
construct <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block headers</a>.</p>
  ...
  <p>In pooled <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool sets the <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target threshold</a> a few orders
...
<a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> checked a percentage of the possible hash values.</p>

  <p>The <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> then sends to the pool a copy of the information the pool
...
transaction</a> must pay the pool.)</p>
  ...
  <p>The information the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> sends to the pool is called a share because it
proves the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> did a share of the work. By chance, some shares the
pool receives will also be below the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target</a>—the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool
sends these to the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> to be added to the <a href="/en/glossary/block-chain" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>.</p>

  <p>The <a href="/en/glossary/block-reward" title="The amount that miners may claim as a reward for creating a block. Equal to the sum of the block subsidy (newly available satoshis) plus the transactions fees paid by transactions included in the block." class="auto-link">block reward</a> and <a href="/en/glossary/transaction-fee" title="The amount remaining when the value of all outputs in a transaction are subtracted from all inputs in a transaction; the fee is paid to the miner who includes that transaction in a block." class="auto-link">transaction fees</a> that come from <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> that <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>
are paid to the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool. The <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool pays out a portion of
these proceeds to individual <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> based on how many shares they generated. For
example, if the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool’s <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target threshold</a> is 100 times lower than
the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target threshold</a>, 100 shares will need to be generated on
average to create a successful <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>, so the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool can pay 1/100th
of its payout for each share received.  Different <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pools use
...
| <a href="/uk/development#devcommunities">Перекласти</a>
  ...
  <p>In both solo and pool <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software needs to get the
...
<a href="/en/developer-reference#getwork" class="auto-link"><code>getwork</code> RPC</a>, which constructs a <a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">header</a> for the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> directly. Since a
...
many modern <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> need to make dozens or hundreds of <a href="/en/developer-reference#getwork" class="auto-link"><code>getwork</code></a> requests
a second. Solo <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> may still use <a href="/en/developer-reference#getwork" class="auto-link"><code>getwork</code></a> on v0.9.5 or below, but most pools today
...
provides the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software with much more information:</p>
...
paying the pool or the solo <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner’s</a> <code>bitcoind</code> <a href="/en/glossary/wallet" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a>.</p>
    </li>
    <li>
      <p>A complete dump of the transactions <code>bitcoind</code> or the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool
suggests including in the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>, allowing the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software to
...
solo <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a>, this is the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> <a href="/en/glossary/nbits" title="The target is the threshold below which a block header hash must be in order for the block to valid, and nBits is the encoded form of the target threshold as it appears in the block header." class="auto-link">target</a>.)</p>
  ...
  <p>Using the transactions received, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software adds a nonce to the
...
Whenever the extra nonce field needs to be changed, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software
rebuilds the necessary parts of the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Umkoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a> and updates the time and
...
ensure they get the most recent work, most <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> use <a href="https://en.wikipedia.org/wiki/Push_technology#Long_polling">HTTP longpoll</a> to
...
<a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool to push a new <a href="/en/developer-reference#getblocktemplate" class="auto-link"><code>getblocktemplate</code></a> to the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> as soon as any
<a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> on the <a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a> publishes a new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> or the pool
wants to send more transactions to the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software.</p>
...
protocol</a>. Stratum focuses on giving <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> the minimal information they
...
paying the pool.</p>
    ...
    <li>
      <p>The parts of the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Umkoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a> which need to be re-hashed to
...
updated with a new extra nonce. The other parts of the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Umkoin, the leaves are almost always transactions from a single block." class="auto-link">merkle
...
<a href="/en/glossary/block-header" title="An 80-byte header belonging to a single block which is hashed repeatedly to create proof of work." class="auto-link">block header</a> for the next <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a>.</p>
  ...
  <p>Using the <a href="/en/glossary/coinbase-transaction" title="The first transaction in a block.  Always created by a miner, it includes a single coinbase." class="auto-link">coinbase transaction</a> received, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software adds a
...
transaction</a>, and adds the hash to the received parts of the <a href="/en/glossary/merkle-tree" title="A tree constructed by hashing paired data (the leaves), then pairing and hashing the results until a single hash remains, the merkle root.  In Umkoin, the leaves are almost always transactions from a single block." class="auto-link">merkle tree</a>.
...
needs to be changed, the <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software updates and re-hashes the
...
<a href="/en/glossary/merkle-root" title="The root node of a merkle tree, a descendant of all the hashed pairs in the tree.  Block headers must include a valid merkle root descended from all transactions in that block." class="auto-link">merkle root</a> field.</p>
  ...
  <p>Unlike <a href="/en/developer-reference#getblocktemplate" class="auto-link"><code>getblocktemplate</code></a>, <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> using Stratum cannot inspect or add
transactions to the <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> they’re currently <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a>. Also unlike
...
so <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> don’t need to use HTTP longpoll to ensure they receive
immediate updates from <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pools when a new <a href="/en/glossary/block" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> is broadcast to the
<a href="/en/developer-guide#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">peer-to-peer network</a>.</p>

      <p><strong>Resources:</strong> The GPLv3 <a href="https://github.com/luke-jr/bfgminer">BFGMiner</a> <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> software and AGPLv3
<a href="https://github.com/luke-jr/eloipool">Eloipool</a> <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">mining</a> pool software are widely-used among <a href="/en/glossary/mining" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miners</a> and
