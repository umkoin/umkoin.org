...
<div class="body">
  ...
  <div id="content" class="content">
    ...
    <p><span class="fa fa-exclamation-triangle"></span> <em>Щоб повідомити про проблему, будь-ласка скористайтесь <a href="https://github.com/umkoin/umkoin.org/issues" target="_blank">сторінкою для сповіщення про проблему</a>.</em></p>
