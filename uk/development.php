...
<div class="body">
  ...
  <div id="content" class="content">
    ...
    <ul>
      ...
      <li>
        <p><strong>Напишіть тести:</strong> Умкойн охоплено багатьма тестами, але пачті, які б покращували покриття тестового інструментарію завжди доречні і це також є найліпшим шляхом до вивчення кодової бази. Перегляньте докуметацію з <a href="https://github.com/umkoin/umkoin/blob/master/README.md#automated-testing">автоматичного тестування</a>.</p>
      </li>
    </ul>
