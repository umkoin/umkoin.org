...
<div class="body">
  ...
  <div id="content" class="content">
    ...
    <h1>Приклади розробки Умкойн</h1>
    <p class="summary">Тут ви знайдете приклади того, як будувати програми за допомогою Умкойн.</p>
...
definition of the term will be displayed in a tooltip.</p>
  ...
  <div class="subhead-links sourcefile" data-sourcefile="_data/devdocs/en/examples/testing.md"><a href="https://github.com/umkoin/umkoin.org/edit/master/_data/devdocs/en/examples/testing.md">Редагувати</a>
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/examples/testing.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/examples/testing.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development.php#devcommunities">Обговорити</a>

| <a href="/uk/development.php#devcommunities">Перекласти</a>
...
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/examples/transactions.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/examples/transactions.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development.php#devcommunities">Обговорити</a>
...
<span class="gp">&gt; </span><span class="nv">UTXO_VOUT</span><span class="o">=</span>0</code></pre></figure>
  ...
  <p>Re-rerun <a href="/en/developer-reference#listunspent" class="auto-link"><code>listunspent</code></a>. We now have three <a href="/en/glossary/unspent-transaction-output" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a>: the two transactions we
...
can send the change back to yourself.</p>
  ...
  <p>Use the <a href="/en/developer-reference#decoderawtransaction" class="auto-link"><code>decoderawtransaction</code> RPC</a> to see exactly what the transaction
...
<span class="gp">&gt; </span><span class="nv">SIGNED_RAW_TX</span><span class="o">=</span>01000000017b1eabe0209b1fe794124575ef807057c77ada[...]</code></pre></figure>
  ...
  <p>Use the <a href="/en/developer-reference#signrawtransaction" class="auto-link"><code>signrawtransaction</code> RPC</a> to sign the transaction created by
...
<span class="gp">&gt; </span><span class="nv">UTXO2_PRIVATE_KEY</span><span class="o">=</span>cT26DX6Ctco7pxaUptJujRfbMS2PJvdqiSMaGaoSktHy[...]</code></pre></figure>
  ...
  <p>Use the <a href="/en/developer-reference#dumpprivkey" class="auto-link"><code>dumpprivkey</code> RPC</a> to get the <a href="/en/glossary/private-key" title="The private portion of a keypair which can create signatures that other people can verify using the public key." class="auto-link">private keys</a> corresponding to the
...
<span class="gp">&gt; </span><span class="nv">UTXO_OUTPUT_SCRIPT</span><span class="o">=</span>a9149af61346ce0aa2dffcf697352b4b704c84dcbaff87</code></pre></figure>
  ...
  <p>We use the <a href="/en/developer-reference#getrawtransaction" class="auto-link"><code>getrawtransaction</code> RPC</a> with the optional second argument
...
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/examples/payment_processing.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/examples/payment_processing.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development.php#devcommunities">Обговорити</a>
...
certificate in <a href="https://en.wikipedia.org/wiki/X.690#DER_encoding" class="auto-link">DER format</a> bearing the signature of the certificate that
...
| <a href="https://github.com/umkoin/umkoin.org/commits/master/_data/devdocs/en/examples/p2p_networking.md">Зміни</a>
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/examples/p2p_networking.md%0A%0A">Зарапортувати помилку</a>
| <a href="/uk/development.php#devcommunities">Обговорити</a>
...
names in the <a href="/en/developer-reference#filterclear" title="A P2P protocol message used to send a filter to a remote peer, requesting that they only send transactions which match the filter."><code>filterload</code> message documentation</a>.
...
<span class="n">send</span><span class="p">(</span><span class="s">"verack"</span><span class="p">,</span> <span class="s">""</span><span class="p">)</span></code></pre></figure>
  ...
  <p>We’re not going to validate their <a href="/en/developer-reference#version" title="A P2P network message sent at the begining of a connection to allow protocol version negotiation" class="auto-link"><code>version</code> message</a> with this simple
script, but we will sleep a short bit and send back our own <a href="/en/developer-reference#verack" title="A P2P network message sent in reply to a version message to confirm a connection has been established" class="auto-link"><code>verack</code>
message</a> as if we had accepted their <a href="/en/developer-reference#version" title="A P2P network message sent at the begining of a connection to allow protocol version negotiation" class="auto-link"><code>version</code> message</a>.</p>
...
1d ................................. Flags: 1 0 1 1 1 0 0 0</code></pre></figure>
  ...
  <p>We parse the above <a href="/en/developer-reference#merkleblock" title="A P2P protocol message used to request a filtered block useful for SPV proofs" class="auto-link"><code>merkleblock</code> message</a> using the following
...
of the parsing checklist in the <a href="/en/developer-reference#merkleblock" title="A P2P protocol message used to request a filtered block useful for SPV proofs" class="auto-link"><code>merkleblock</code> message</a> section.</p>
