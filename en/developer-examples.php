...
<div class="body">
  ...
  <div id="content" class="content">
    ...
    <p>When run with no arguments, all Umkoin Core programs default to Umkoin’s main <a href="/en/developer-guide.php#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> (<a href="/en/glossary/mainnet.php" title="The original and main network for Umkoin transactions, where satoshis have real economic value." id="term-mainnet" class="term">mainnet</a>). However, for development, it’s safer and cheaper to use Umkoin’s test <a href="/en/developer-guide.php#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> (<a href="/en/glossary/testnet.php" title="A global testing environment in which developers can obtain and spend satoshis that have no real-world value on a network that is very similar to the Umkoin mainnet." class="auto-link">testnet</a>) where the <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractins of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> spent have no real-world value. <a href="/en/glossary/testnet.php" title="A global testing environment in which developers can obtain and spend satoshis that have no real-world value on a network that is very similar to the Umkoin mainnet." class="auto-link">Testnet</a> also relaxes some restrictions (such as <a href="/en/glossary/standard-transaction.php" title="A transaction that passes Umkoin Core's IsStandard() and IsStandardTx() tests. Only standard transactions are mined or broadcast by peers running the default Umkoin Core software." class="auto-link">standard transaction</a> checks) so you can test functions which might currently be disabled by default on <a href="/en/glossary/mainnet.php" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a>.</p>
    <p>To use <a href="/en/glossary/testnet.php" title="A global testing environment in which developers can obtain and spend satoshis that have no real-world value on a network that is very similar to the Umkoin mainnet." class="auto-link">testnet</a>, use the argument <code>-testnet</code> with <code>umkoin-cli</code>, <code>umkoind</code> or <code>umkoin-qt</code> or add <code>testnet=1</code> to your <code>umkoin.conf</code> file as <a href="/en/developer-examples.php">described earlier</a>. To get free <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> for testing, use <a href="https://tpfaucet.appspot.com/">Piotr Piasecki’s testnet faucet</a>. <a href="/en/glossary/testnet.php" title="A global testing environment in which developers can obtain and spend satoshis that have no real-world value on a network that is very similar to the Umkoin mainnet." class="auto-link">Testnet</a> is a public resource provided for free by members of the community, so please don’t abuse it.</p>
    ...
    <p>Start <code>umkoind</code> in <a href="/en/glossary/regression-test-mode.php" title="A local testing environment in which developers can almost instantly generate blocks on demand for testing events, and can create private satoshis with no real-world value." class="auto-link">regtest mode</a> to create a private <a href="/en/glossary/block-chain.php" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>.</p>
...
umkoin-cli -regtest generate 101
    ...
    <p>Generate 101 <a href="/en/glossary/block.php" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> using a special <a href="/en/developer-reference.php#remote-procedure-calls-rpcs" class="auto-link">RPC</a> which is only available in <a href="/en/glossary/regression-test-mode.php" title="A local testing environment in which developers can almost instantly generate blocks on demand for testing events, and can create private satoshis with no real-world value." class="auto-link">regtest mode</a>. This takes less than a second on a generic PC. Because this is a new <a href="/en/glossary/block-chain.php" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> using Umkoin’s default rules, the first <a href="/en/glossary/block.php" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> pay a <a href="/en/glossary/block-reward.php" title="The amount that miners may claim as a reward for creating a block. Equal to the sum of the block subsidy (newly available satoshis) plus the transactions fees paid by transactions included in the block." class="auto-link">block reward</a> of 50 <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">umkoins</a>. Unlike <a href="/en/glossary/mainnet.php" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a>, in <a href="/en/glossary/regression-test-mode.php" title="A local testing environment in which developers can almost instantly generate blocks on demand for testing events, and can create privat satoshis with no real-world value." class="auto-link">regtest mode</a> only the first 150 <a href="/en/glossary/block.php" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> pay a reward of 50 <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">umkoins</a>. However, a <a href="/en/glossary/block.php" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> must have 100 <a href="/en/glossary/confirmation-score.php" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">confirmations</a> before that reward can be spent, so we generate 101 <a href="/en/glossary/block.php" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">blocks</a> to get access to the <a href="/en/glossary/coinbase-transaction.php" title="The first transaction in a block. Always created by a miner, it includes a single coinbase." class="auto-link">coinbase transaction</a> from <a href="/en/glossary/block.php" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> #1.</p>
...
50.00000000</code></pre></figure>
    ...
    <p>Verify that we now have 50 <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">umkoins</a> available to spend.</p>
    ...
    <p><a href="/en/glossary/regression-test-mode.php" title="A local testing environment in which developers can almost instantly generate blocks on demand for testing events, and can create private satoshis with no real-world value." class="auto-link">Regtest</a> <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallets</a> and <a href="/en/glossary/block-chain.php" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> state (chainstate) are saved in the <code>regtest</code> subdirectory of the Umkoin Core configuration directory. You can safely delete the <code>regtest</code> subdirectory and restart Umkoin Core to start a new <a href="/en/glossary/regression-test-mode.php" title="A local testing environment in which developers can almost instantly generate blocks on demand for testing events, and can create private satoshis with no real-world value." class="auto-link">regtest</a>. (See the <a href="/en/developer-examples">Developer Examples Introduction</a> for default configuration directory locations on various operating systems. Always back up <a href="/en/glossary/mainnet.php" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a> <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto>wallets</a> before performing dangerous operations such as deleting.)</p>
    ...
    <p>Umkoin Core provides several <a href="/en/developer-reference.php#remote-procedure-calls-rpcs" class="auto-link">RPCs</a> which handle all the details of spending, including creating <a href="/en/glossary/change-address.php" title="An output in a transaction which returns satoshis to the spender, thus preventing too much of the input value from going to transaction fees." class="auto-link">change outputs</a> and paying appropriate fees. Even advanced users should use these <a href="/en/developer-reference.php#remote-procedure-calls-rpcs" class="auto-link">RPCs</a> whenever possible to decrease the chance that <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> will be lost by mistake.</p>
...
mvbnrCX3bg1cDRUu8pkecrvP6vQkSLDSou
    ...
    <p>Get a new Umkoin <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">address</a> and save it in the shell variable <code>$NEW_ADDRESS</code>.</p>
...
263c018582731ff54dc72c7d67e858c002ae298835501d80200f05753de0edf0</code></pre></figure>
    ...
    <p>Use the <a href="/en/developer-reference.php#listunspent" class="auto-link"><code>listunspent</code> RPC</a> to display the <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a> belonging to this <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a>. The list is empty because it defaults to only showing <a href="/en/glossary/confirmation-score.php" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">confirmed</a> <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a> and we just spent our only <a href="/en/glossary/confirmation-score.php" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">confirmed</a> <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a>.</p>
    ...
    <p>Re-running the <a href="/en/developer-reference.php#listunspent" class="auto-link"><code>listunspent</code> RPC</a> with the argument “0” to also display <a href="/en/glossary/confirmation-score.php" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transactions</a> shows that we have two <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a>, both with the same <a href="/en/glossary/txid.php" title="An identifier used to uniquely identify a particular transaction; specifically, the sha256d hash of the transaction." class="auto-link">txid</a>. The first <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a> shown is a <a href="/en/glossary/change-address.php" title="An output in a transaction which returns satoshis to the spender, thus preventing too much of the input value from going to transaction fees." class="auto-link">change output</a> that <a href="/en/developer-reference.php#sendtoaddress" class="auto-link"><code>sendtoaddress</code></a> created using a new <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">address</a> from the key pool. The second <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a> shown is the spend to the <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">address</a> we provided. If we had spent those <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in ons of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to someone else, that second transaction would not be displayed in our list of <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a>.</p>
...
delay broadcasting those transactions. However, mistakes made in <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw
transactions</a> may not be detected by Umkoin Core, and a number of <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw
transaction</a> users have permanently lost large numbers of <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">satoshis</a>, so
please be careful using <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transactions</a> on <a href="/en/glossary/mainnet.php" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a>.</p>

  <p>This subsection covers one of the simplest possible <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transactions</a>.</p>
...
<span class="gp">&gt; </span><span class="nv">UTXO_VOUT</span><span class="o">=</span>0</code></pre></figure>
  ...
  <p>Re-rerun <a href="/en/developer-reference.php#listunspent" class="auto-link"><code>listunspent</code></a>. We now have three <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a>: the two transactions we
created before plus the <a href="/en/glossary/coinbase-transaction.php" title="The first transaction in a block. Always created by a miner, it includes a single coinbase." class="auto-link">coinbase transaction</a> from <a href="/en/glossary/block.php" title="One or more transactions prefaced by a block header and protected by proof of work. Blocks are the data stored on the block chain." class="auto-link">block</a> #2. We save the
<a href="/en/glossary/txid.php" title="An identifier used to uniquely identify a particular transaction; specifically, the sha256d hash of the transaction." class="auto-link">txid</a> and <a href="/en/developer-guide.php#term-output-index" title="The sequentially-numbered index of outputs in a single transaction starting from 0" class="auto-link">output index</a> number (vout) of that <a href="/en/glossary/coinbase.php" title="A special field used as the sole input for coinbase transactions. The coinbase allows claiming the block reward and provides up to 100 bytes for arbitrary data." class="auto-link">coinbase</a> <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a> to shell
variables.</p>
...
<span class="gp">&gt; </span><span class="nv">NEW_ADDRESS</span><span class="o">=</span>mz6KvC4aoUeo6wSxtiVQTo7FDwPnkp6URG</code></pre></figure>
  ...
  <p>Get a new <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">address</a> to use in the <a href="/en/glossary/serialized-transaction.php">serialized transaction</a>. Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transaction</a>.</p>
...
this example, our <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number. The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a> had 50.0000 <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">umkoins</a> and our <a href="/en/glossary/output.php" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a>
(<code>$NEW_ADDRESS</code>) is being paid 49.9999 <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">umkoins</a>, so the transaction will
include a fee of 0.0001 <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">umkoins</a>. If we had paid <code>$NEW_ADDRESS</code> only 10
...
would be a whopping 40 <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">umkoins</a>. See the Complex <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">Raw Transaction</a>
...
<span class="gp">&gt; </span><span class="nv">UTXO2_ADDRESS</span><span class="o">=</span>muhtvdmsnbQEPFuEmxcChX58fGvXaaUoVt</code></pre></figure>
  ...
  <p>For our two <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number. The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a>, we select two <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a> by placing the <a href="/en/glossary/txid.php" title="An identifier used to uniquely identify a particular transaction; specifically, the sha256d hash of the transaction." class="auto-link">txid</a> and <a href="/en/developer-guide.php#term-output-index" title="The sequentially-numbered index of outputs in a single transaction starting from 0" class="auto-link">output
index</a> numbers (vouts) in shell variables. We also save the <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">addresses</a>
corresponding to the <a href="/en/glossary/public-key.php" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a> (hashed or unhashed) used in those
transactions. We need the <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">addresses</a> so we can get the corresponding
...
<a href="/en/glossary/public-key.php" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a> used in the two <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXOs</a> out <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number. The outpoint references a previous output and the signature script allows spending it." class="auto-link">inputs</a> we will be spending. We need
...
<a href="/en/glossary/mainnet.php" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a>.</p>
...
<span class="gp">&gt; </span><span class="nv">PARTLY_SIGNED_RAW_TX</span><span class="o">=</span>0100000002f327e86da3e66bd20e1129b1fb36d07[...]</code></pre></figure>
  ...
  <p>Signing the <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transaction</a> with <a href="/en/developer-reference.php#signrawtransaction" class="auto-link"><code>signrawtransaction</code></a> gets more
complicated as we now have three arguments:</p>

  <ol>
    <li>
      <p>The unsigned <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transaction</a>.</p>
    </li>
    <li>
...
the <a href="/en/glossary/block-chain.php" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> or memory pool.</p>
...
| <a href="https://github.com/umkoin/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/examples/transactions.md%0A%0A">Report Issue</a>
  ...
  <p>We will now spend the transaction created in the Complex <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">Raw Transaction</a>
...
same basic process used by <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> programs for offline
signing—which generally means signing a transaction without access
to the current <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a> set.</p>

  <p>Offline signing is safe. However, in this example we will also be
spending an/glossary/output.php" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> which is not part of the <a href="/en/glossary/block-chain.php" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a> because the
transaction containing it has never been broadcast. That can be unsafe:</p>

  <p><img src="/img/icons/icon_warning.svg" alt="Warning icon" />
 <strong>Warning:</strong> Transactions which spend <a href="/en/glossary/output.php" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">outputs</a> from <a href="/en/glossary/confirmation-score.php" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed
...
<a href="/en/glossary/confirmation-score.php" title="A score indicating the number of blocks on the best block chain that would need to be modified to remove or modify a particular transaction. A confirmed transaction has a confirmation score of one or higher." class="auto-link">unconfirmed transactions</a> on <a href="/en/glossary/mainnet.php" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a>.</p>
...
<span class="gp">&gt; </span><span class="nv">NEW_ADDRESS</span><span class="o">=</span>mfdCHEFL2tW9eEUpizk7XLZJcnFM4hrp78</code></pre></figure>
  ...
  <p>Get a new <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">address</a> to spend the <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> to.</p>
...
subsections.</p>
  ...
  <p>Attempt to sign the <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transaction</a> without any special arguments, the
way we successfully signed the the <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transaction</a> in the Simple <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">Raw
...
<a href="/en/developer-reference.php#createrawtransaction" class="auto-link"><code>createrawtransaction</code></a> <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transaction</a>. But the data that gets signed
...
though it doesn’t appear in either the unsigned or signed transaction.</p>
  ...
  <p>In the other <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transaction</a> subsections above, the previous <a href="/en/glossary/output.php" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> was
part of the <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a> set known to the <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a>, so the <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> was able to use
...
script</a> and other required <a href="/en/glossary/input" title="An input in a transaction which contains three fields: an outpoint, a signature script, and a sequence number. The outpoint references a previous output and the signature script allows spending it." class="auto-link">input</a> data.</p>
  ...
  <p>This specific operation is typically what offline signing <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallets</a> do.
The online <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> creates the <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transaction</a> and gets the previous
...
the offline <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a>. After displaying the transaction details to the
user, the offline <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> signs the transaction as we did above. The
user takes the signed transaction back to the online <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a>, which
broadcasts it.</p>
...
transaction spends an <a href="/en/glossary/output.php" title="An output in a transaction which contains two fields: a value field for transferring zero or more satoshis and a pubkey script for indicating what conditions must be fulfilled for those satoshis to be further spent." class="auto-link">output</a> which is not a <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a> the <a href="/en/glossary/node.php" title="A computer that connects to the Umkoin network." class="auto-link">node</a> knows about.</p>
...
the <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a>.</p>
...
above have not yet become part of the <a href="/en/glossary/regression-test-mode.php" title="A local testing environment in which developers can almost instantly generate blocks on demand for testing events, and can create private satoshis with no real-world value." class="auto-link">regtest</a> <a href="/en/glossary/block-chain.php" title="A chain of blocks with each block referencing the block that preceded it. The most-difficult-to-recreate chain is the best block chain." class="auto-link">block chain</a>. However, they
...
redeem script</a>. You must give them a full <a href="/en/glossary/public-key.php" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a>.</p>
...
<span class="gp">&gt; </span><span class="nv">NEW_ADDRESS3_PUBLIC_KEY</span><span class="o">=</span>029e03a901b85534ff1e92c43c74431f7ce720[...]</code></pre></figure>
  ...
  <p>Use the <a href="/en/developer-reference.php#validateaddress" class="auto-link"><code>validateaddress</code> RPC</a> to display the full (unhashed) <a href="/en/glossary/public-key.php" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a>
for one of the <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">addresses</a>. This is the information which will 
...
a <a href="/en/glossary/multisig" title="A pubkey script that provides *n* number of pubkeys and requires the corresponding signature script provide *m* minimum number signatures corresponding to the provided pubkeys." class="auto-link">multisig output</a> or <a href="/en/glossary/p2sh-multisig" title="A P2SH output where the redeem script uses one of the multisig opcodes. Up until Umkoin Core 0.10.0, P2SH multisig scripts were standard transactions, but most other P2SH scripts were not." class="auto-link">P2SH multisig redeem script</a>.</p>
  ...
  <p>We save the <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">address</a> returned to a shell variable.</p>
...
<a href="/en/glossary/signature" title="A value related to a public key which could only have reasonably been created by someone who has the private key that created that public key. Used in Umkoin to authorize spending satoshis previously sent to a public key." class="auto-link">signatures</a> required and a list of <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">addresses</a> or <a href="/en/glossary/public-key.php" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a>. Because
...
<a href="/en/developer-reference.php#remote-procedure-calls-rpcs" class="auto-link">RPC</a>, the only <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">addresses</a> which can be provided are those belonging to a
<a href="/en/glossary/public-key.php" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a> in the <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a>. In this case, we provide two <a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">addresses</a> and
one <a href="/en/glossary/public-key.php" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public key</a>—all of which will be converted to <a href="/en/glossary/public-key.php" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a> in the
...
by running the same command above, with the <a href="/en/glossary/public-key.php" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a> listed in the
...
the <a href="/en/glossary/public-key.php" title="The public portion of a keypair which can be used to verify signatures made with the private portion of the keypair." class="auto-link">public keys</a>, you will never be able to spend <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> sent to that
...
before, this command automatically selects an <a href="/en/glossary/unspent-transaction-output.php" title="An Unspent Transaction Output (UTXO) that can be spent as an input in a new transaction." class="auto-link">UTXO</a>, creates a <a href="/en/glossary/change-address.php" title="An output in a transaction which returns satoshis to the spender, thus preventing too much of the input value from going to transaction fees." class="auto-link">change
...
<span class="gp">&gt; </span><span class="nv">RAW_TX</span><span class="o">=</span>010000000175e1769813db8418fea17576694af1ff31cb2b512b733[...]</code></pre></figure>
  ...
  <p>We generate the <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">raw transaction</a> the same way we did in the Simple <a href="/en/glossary/serialized-transaction.php" title="Complete transactions in their binary format; often represented using hexadecimal. Sometimes called raw format because of the various Umkoin Core commands with &quot;raw&quot; in their names." class="auto-link">Raw
...
<a href="/en/glossary/mainnet.php" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a>. See the warning in the <a href="/en/developer-examples#complex-raw-transaction">complex raw transaction section</a>.</p>
...
the spender’s Umkoin <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> program on the URI. If the <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> program is
...
certificate will not work.)</p>
  ...
  <p>Each <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> program may choose which certificate authorities to trust,
but it’s likely that they’ll trust whatever certificate authorities their
operating system trusts. If the <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> program doesn’t have a full
operating system, as might be the case for small hardware <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallets</a>, <a href="https://github.com/umkoin/bips/blob/master/bip-0070.mediawiki" class="auto-link">BIP70</a>
...
your webserver, it will work for your <a href="/en/developer-examples#term-paymentrequest" title="The PaymentRequest of the payment protocol which contains and allows signing of the PaymentDetails" class="auto-link">PaymentRequests</a>.</p>
  ...
  <p><code>network</code>: (optional) tell the spender’s <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> program what Umkoin <a href="/en/developer-guide.php#term-network" title="The Umkoin P2P network which broadcasts transactions and blocks" class="auto-link">network</a> you’re
using; <a href="https://github.com/umkoin/bips/blob/master/bip-0070.mediawiki" class="auto-link">BIP70</a> defines “main” for <a href="/en/glossary/mainnet.php" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a> (actual payments) and “test” for
<a href="/en/glossary/testnet.php" title="A global testing environment in which developers can obtain and spend satoshis that have no real-world value on a network that is very similar to the Umkoin mainnet." class="auto-link">testnet</a> (like <a href="/en/glossary/mainnet.php" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a>, but fake <a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> are used). If the <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a>
...
<a href="/en/developer-examples#term-paymentrequest" title="The PaymentRequest of the payment protocol which contains and allows signing of the PaymentDetails" class="auto-link">PaymentRequest</a>.</p>
  ...
  <p><code>payment_url</code>: (required) tell the spender’s <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> program where to send the Payment
...
attacks from modifying the message.</p>
  ...
  <p><code>payment_details_version</code>: (optional) tell the spender’s <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a> program what version of the
...
<span class="n">details</span><span class="o">.</span><span class="n">merchant_data</span> <span class="o">=</span> <span class="s">"Invoice #123"</span></code></pre></figure>
  ...
  rate conversion tool. If you leave the amount blank, the <a href="/en/glossary/wallet.php" title="Software that stores private keys and monitors the block chain (sometimes as a client of a server that does the processing) to allow users to spend and receive satoshis." class="auto-link">wallet</a>
...
<a href="/en/glossary/address.php" title="A 20-byte hash formatted using base58check to produce either a P2PKH or P2SH Umkoin address. Currently the most common way users exchange payment information." class="auto-link">address</a> used in the URI examples throughout this section,
...
total based on a <a href="/en/developer-guide.php#term-fiat" title="National currencies such as the dollar or euro" class="auto-link">fiat</a>-to-<a href="/en/glossary/denominations.php" title="Denominations of Umkoin value, usually measured in fractions of a umkoin but sometimes measured in multiples of a satoshi. One umkoin equals 100,000,000 satoshis." class="auto-link">satoshis</a> exchange rate, you probably want to
