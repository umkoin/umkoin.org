...
| <a href="https://github.com/bitcoin-dot-org/umkoin.org/issues/new?body=Source%20File%3A%20_data/devdocs/en/examples/testing.md%0A%0A">Report Issue</a>
...
which might currently be disabled by default on <a href="/en/glossary/mainnet" title="The original and main network for Umkoin transactions, where satoshis have real economic value." class="auto-link">mainnet</a>.</p>
  ...
  <p>To use <a href="/en/glossary/testnet" title="A global testing environment in which developers can obtain and spend satoshis that have no real-world value on a network that is very similar to the Umkoin mainnet." class="auto-link">testnet</a>, use the argument <code>-testnet</code> with <code>bitcoin-cli</code>, <code>bitcoind</code> or <code>bitcoin-qt</code> or add
...
50.00000000</code></pre></figure>
  ...
  <p>You can now use Umkoin Core <a href="/en/developer-reference#remote-procedure-calls-rpcs" class="auto-link">RPCs</a> prefixed with <code>bitcoin-cli -regtest</code>.</p>
