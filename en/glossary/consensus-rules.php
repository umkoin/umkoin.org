...
<title>Consensus Rules, Validation Rules - Umkoin Glossary</title>
...
<div class="body">
  ...
  <div id="content" class="content">
    ...
    <ul>
      <li><a href="/en/glossary/consensus.php" title="When several nodes (usually most nodes on the network) all have the same blocks in their locally-validated best block chain." class="auto-link">Consensus</a> (what happens when <a href="/en/glossary/node.php" title="A computer that connects to the Umkoin network." class="auto-link">nodes</a> follow the same <a href="/en/glossary/consensus-rules.php" title="The block validation rules that full nodes follow to stay in consensus with other nodes." class="auto-link">consensus rules</a>)</li>
    </ul>

    <h3 id="links">Links</h3>
    <ul>
      <li><a href="/en/developer-guide.php#term-consensus-rules">Consensus rules</a> — Umkoin.org Developer Guide</li>
    </ul>
