...
<title>User Activated Soft Fork, UASF - Umkoin Glossary</title>
...
<div class="body">
  ...
  <div id="content" class="content">
    ...
    <h1>User Activated Soft Fork, UASF</h1>
    <?php include 'notice.php'; ?>

    <h2 id="definition">Definition</h2>
    <p>A <a href="/en/glossary/soft-fork.php" title="A softfork is a change to the umkoin protocol  wherein only previously valid blocks/transactions  are made invalid. Since old nodes will recognise  the new blocks as valid, a softfork is backward-compatible." class="auto-link">Soft Fork</a> activated by flag day or <a href="/en/glossary/node.php" title="A computer that connects to the Umkoin network." class="auto-link">node</a> enforcement instead of <a href="/en/glossary/mining.php" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> signalling.</p>

    <h3 id="synonyms">Synonyms</h3>
    <ul>
      <li>
        <p>User-activated soft fork</p>
      </li>
      <li>
        <p>UASF</p>
      </li>
    ...
    <ul>
      <li>
        <p><a href="/en/glossary/mining.php" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">Miner</a> Activated <a href="/en/glossary/soft-fork.php" title="A softfork is a change to the umkoin protocol  wherein only previously valid blocks/transactions  are made invalid. Since old nodes will recognise  the new blocks as valid, a softfork is backward-compatible." class="auto-link">Soft Fork</a> (a <a href="/en/glossary/soft-fork.php" title="A softfork is a change to the umkoin protocol  wherein only previously valid blocks/transactions  are made invalid. Since old nodes will recognise  the new blocks as valid, a softfork is backward-compatible." class="auto-link">soft fork</a> activated through <a href="/en/glossary/mining.php" title="Mining is the act of creating valid Umkoin blocks, which requires demonstrating proof of work, and miners are devices that mine or people who own those devices." class="auto-link">miner</a> signalling)</p>
      </li>
      <li>
