...
<div class="body">
  ...
  <div id="content" class="content">
    ...
    <tbody>
      <tr>
        <td>
          <span title="Текущее количество добытых блоков начиная с нулевого."><i class="fa fa-signal"></i> <?php print("<a href='http://" . $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF'] . "?block=" . $block->getblockcount() . "'>" . $block->getblockcount() . "</a>"); ?></span>
        </td>
        <td>
